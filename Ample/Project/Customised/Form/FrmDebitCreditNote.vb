...
#End Region
    ...
    Private Sub AccountPosting(ByVal SearchCode As String, ByVal Conn As SqliteConnection, ByVal Cmd As SqliteCommand)
    ...
    Private Sub FrmPaymentReceipt_BaseEvent_ApproveDeletion_InTrans(ByVal SearchCode As String, ByVal Conn As SqliteConnection, ByVal Cmd As SqliteCommand) Handles Me.BaseEvent_ApproveDeletion_InTrans
    ...
    Private Sub FrmQuality1_BaseFunction_FIniMast(ByVal BytDel As Byte, ByVal BytRefresh As Byte) Handles Me.BaseFunction_FIniMast
        ...
        mQry = "Select DocID As SearchCode " & _
                ...
                " Where IfNull(IsDeleted,0)=0 And IfNull(H.TransactionType,'Debit Note')='" & IIf(mTransactionType = TransactionType.DebitNote, "Debit Note", "Credit Note") & "'  " & mCondStr & "  Order By V_Date Desc "
    ...
    Public Function FGetLedgerBalance(ByVal StrSubCode As String, ByVal V_Date As String, ByVal Site_Code As String) As Double
        ...
        Try
            DTTemp = AgL.FillData("Select (IfNull(Sum(LG.AmtDr),0)-IfNull(Sum(LG.AmtCr),0)) As Balance From Ledger LG Where LG.SubCode='" & StrSubCode & "' And LG.Site_Code='" & Site_Code & "' And LG.V_Date <= '" & V_Date & "' ", AgL.GCn).Tables(0)
