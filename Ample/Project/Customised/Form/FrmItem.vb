...
#Region "Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.TxtFormType = New AgControls.AgTextBox()
        ...
        Me.LblDescription.Location = New System.Drawing.Point(193, 101)
        ...
        Me.LblUnit.Location = New System.Drawing.Point(193, 120)
        ...
        Me.LblManualCode.Location = New System.Drawing.Point(193, 81)
        ...
        Me.Label3.Location = New System.Drawing.Point(193, 140)
        ...
        Me.TxtMeasureUnit.Location = New System.Drawing.Point(589, 252)
        ...
        Me.TxtMeasureUnit.Visible = False
        '
        'LblMeasureUnit
        '
        ...
        Me.LblMeasureUnit.Location = New System.Drawing.Point(472, 254)
        ...
        Me.LblMeasureUnit.Visible = False
        '
        'TxtMeasure
        '
        Me.TxtMeasure.AgAllowUserToEnableMasterHelp = False
        Me.TxtMeasure.AgLastValueTag = Nothing
        Me.TxtMeasure.AgLastValueText = Nothing
        ...
        Me.TxtMeasure.Location = New System.Drawing.Point(353, 252)
        ...
        Me.LblMeasure.Location = New System.Drawing.Point(257, 254)
        ...
        Me.LblMeasure.Visible = False
        '
        'TxtPointValue
        '
        Me.TxtPointValue.AgAllowUserToEnableMasterHelp = False
        Me.TxtPointValue.AgLastValueTag = Nothing
        Me.TxtPointValue.AgLastValueText = Nothing
        ...
        Me.Label6.Location = New System.Drawing.Point(191, 182)
        ...
        Me.TxtBusinessVolume.AgLastValueTag = Nothing
        Me.TxtBusinessVolume.AgLastValueText = Nothing
        ...
        Me.Label10.Location = New System.Drawing.Point(292, 168)
        ...
        Me.TxtSalesTaxGroup.Location = New System.Drawing.Point(308, 160)
        Me.TxtSalesTaxGroup.MaxLength = 20
        Me.TxtSalesTaxGroup.Name = "TxtSalesTaxGroup"
        Me.TxtSalesTaxGroup.Size = New System.Drawing.Size(351, 18)
        Me.TxtSalesTaxGroup.TabIndex = 6
        '
        'Label11
        '
        Me.Label11.AutoSize = True
        Me.Label11.Font = New System.Drawing.Font("Arial", 9.75!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.Label11.Location = New System.Drawing.Point(191, 162)
        ...
        Me.TxtMrp.Location = New System.Drawing.Point(544, 140)
        Me.TxtMrp.MaxLength = 20
        Me.TxtMrp.Name = "TxtMrp"
        Me.TxtMrp.Size = New System.Drawing.Size(115, 18)
        ...
        Me.Label12.Location = New System.Drawing.Point(429, 140)
        ...
        'TxtFormType
        '
        Me.TxtFormType.AgAllowUserToEnableMasterHelp = False
        Me.TxtFormType.AgLastValueTag = Nothing
        Me.TxtFormType.AgLastValueText = Nothing
        Me.TxtFormType.AgMandatory = False
        Me.TxtFormType.AgMasterHelp = False
        Me.TxtFormType.AgNumberLeftPlaces = 0
        Me.TxtFormType.AgNumberNegetiveAllow = False
        Me.TxtFormType.AgNumberRightPlaces = 0
        Me.TxtFormType.AgPickFromLastValue = False
        Me.TxtFormType.AgRowFilter = ""
        Me.TxtFormType.AgSearchMethod = AgControls.AgLib.TxtSearchMethod.Simple
        Me.TxtFormType.AgSelectedValue = Nothing
        Me.TxtFormType.AgTxtCase = AgControls.AgTextBox.TxtCase.None
        Me.TxtFormType.AgValueType = AgControls.AgTextBox.TxtValueType.Text_Value
        Me.TxtFormType.BorderStyle = System.Windows.Forms.BorderStyle.None
        Me.TxtFormType.Font = New System.Drawing.Font("Arial", 11.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.TxtFormType.Location = New System.Drawing.Point(723, 252)
        Me.TxtFormType.MaxLength = 20
        Me.TxtFormType.Name = "TxtFormType"
        Me.TxtFormType.Size = New System.Drawing.Size(115, 18)
        Me.TxtFormType.TabIndex = 718
        Me.TxtFormType.Visible = False
        '
        'FrmItem
        '
        Me.AutoScaleDimensions = New System.Drawing.SizeF(6.0!, 13.0!)
        Me.ClientSize = New System.Drawing.Size(862, 324)
        Me.Controls.Add(Me.TxtFormType)
        ...
        Me.Controls.SetChildIndex(Me.TxtMrp, 0)
        Me.Controls.SetChildIndex(Me.TxtFormType, 0)
    ...
    Protected WithEvents TxtFormType As AgControls.AgTextBox
...
#End Region
    ...
    Public Sub FrmYarn_BaseEvent_FindMain() Handles Me.BaseEvent_FindMain
        ...
        If mFormType = "Active" Then
            mConStr += "  And I.Status='Active'  "
        End If


        AgL.PubFindQry = "SELECT I.Code, I.ManualCode as [Item_Code], I.Description [Item_Description], I.Unit, I.Rate, G.Description as Item_Group, C.Description as Item_Category " &
                        " FROM Item I " &
                        " Left Join ItemGroup G On I.ItemGroup = G.Code " &
                        " Left Join ItemCategory C On G.ItemCategory = C.Code " &
                        "  " & mConStr &
    ...
    Private Sub FrmYarn_BaseFunction_FIniMast(ByVal BytDel As Byte, ByVal BytRefresh As Byte) Handles Me.BaseFunction_FIniMast
        ...
        If mFormType = "Active" Then
            mConStr += "  And I.Status='Active'  "
        Else
            If MsgBox("Show only active items?", MsgBoxStyle.YesNo) = vbYes Then
                mFormType = "Active"
                mConStr += "  And I.Status='Active'  "
            End If
        End If
    ...
    Private Sub FrmQuality1_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        mQry = "Select I.Code, I.ManualCode, I.Description, I.Unit, I.Rate, I.ItemGroup, I.SalesTaxPostingGroup, " &
            " G.Description as ItemGroupDesc, I.MeasureUnit, I.Measure,I.PointValue, I.BusinessVolume, I.MRP " &
            " From Item I " &
            " Left Join ItemGroup G On I.ItemGroup = G.Code  " &
        ...
        With DsTemp.Tables(0)
            If .Rows.Count > 0 Then
                ...
                TxtMrp.Text = AgL.VNull(.Rows(0)("MRP"))
    ...
    Private Sub FrmYarn_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As SQLiteConnection, ByVal Cmd As SQLiteCommand) Handles Me.BaseEvent_Save_InTrans
        mQry = "UPDATE Item " &
                ...
                " ItemGroup = " & AgL.Chk_Text(TxtItemGroup.Tag) & ", " &
                " ItemType = " & AgL.Chk_Text(ClsMain.ItemType.RawMaterial) & ", " &
                " Measure = " & Val(TxtMeasure.Text) & ", " &
                " MeasureUnit = " & AgL.Chk_Text(TxtMeasureUnit.Text) & ", " &
                " SalesTaxPostingGroup = " & AgL.Chk_Text(TxtSalesTaxGroup.Tag) & ", " &
                " PointValue = " & Val(TxtPointValue.Text) & ", " &
                " BusinessVolume = " & Val(TxtBusinessVolume.Text) & ", " &
    ...
    Private Sub TxtSalesTaxGroup_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TxtSalesTaxGroup.KeyDown, TxtItemGroup.KeyDown, TxtBusinessVolume.KeyDown
        Select Case sender.name
            Case TxtSalesTaxGroup.Name
                If CType(sender, AgControls.AgTextBox).AgHelpDataSet Is Nothing Then
                    If e.KeyCode <> Keys.Enter Then
                        mQry = "SELECT Description as  Code, Description AS PostingGroupSalesTaxItem " &
                               "FROM PostingGroupSalesTaxItem Where IfNull(Active,0)=1 "
            ...
            Case TxtItemGroup.Name
                If CType(sender, AgControls.AgTextBox).AgHelpDataSet Is Nothing Then
                    If e.KeyCode <> Keys.Enter Then
                        mQry = "Select H.Code, H.Description as Item_Group, C.Description as Item_Category " &
                               "From ItemGroup H " &
                               "Left Join ItemCategory C On H.ItemCategory = C.Code " &
                               "Where H.ItemType = '" & ClsMain.ItemType.RawMaterial & "' " &
