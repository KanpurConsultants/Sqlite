...
#End Region
    ...
    Private Sub FrmQuality1_BaseFunction_FIniMast(ByVal BytDel As Byte, ByVal BytRefresh As Byte) Handles Me.BaseFunction_FIniMast
        ...
        mQry = "Select DocID As SearchCode " & _
                ...
                " Where IfNull(IsDeleted,0)=0 And IfNull(H.TransactionType,'Payment')='" & IIf(mTransactionType = TransactionType.Payment, "Payment", "Receipt") & "'  " & mCondStr & "  Order By V_Date Desc "
