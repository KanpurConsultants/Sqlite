...
#Region "Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.TxtItemCategory.Location = New System.Drawing.Point(311, 138)
        ...
        Me.Label3.Location = New System.Drawing.Point(295, 147)
...
#End Region
    ...
    Public Overridable Sub FrmYarn_BaseEvent_FindMain() Handles Me.BaseEvent_FindMain
        Dim mConStr$ = " Where I.ItemType = '" & ClsMain.ItemType.RawMaterial & "' "

        AgL.PubFindQry = "SELECT I.Code, I.Description as Item_Group, C.Description as Item_Category  " &
                        " FROM ItemGroup I  " &
    ...
    Private Sub FrmYarn_BaseFunction_FIniMast(ByVal BytDel As Byte, ByVal BytRefresh As Byte) Handles Me.BaseFunction_FIniMast
        Dim mConStr$ = ""
        mConStr = "WHERE 1=1   " & AgL.RetDivisionCondition(AgL, "Div_Code") & " And I.ItemType = '" & ClsMain.ItemType.RawMaterial & "' "
        mQry = "Select I.Code As SearchCode " &
                " From ItemGroup I " & mConStr &
    ...
    Private Sub TxtItemCategory_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles TxtItemCategory.Enter
        mQry = "Select Code, Description " &
               "From ItemCategory " &
               "Where ItemType = '" & ClsMain.ItemType.RawMaterial & "' " &
               "Order By Description "
