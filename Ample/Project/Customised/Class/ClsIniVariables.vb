...
Public Class ClsIniVariables
    ...
    Public Sub FOpenCompanyConnection()
        ...
        Else
            ...
            'Agl.ECompConn_ConnectionString = "Data Source=(LocalDb)\MSSQLLocalDB;Initial Catalog=Ampl;Integrated Security=True"
            Agl.ECompConn.ConnectionString = Agl.ECompConn_ConnectionString
            ...
            'Agl.GcnMain_ConnectionString = "Data Source=(LocalDb)\MSSQLLocalDB;Initial Catalog=Ampl;Integrated Security=True"
            Agl.GcnMain.ConnectionString = Agl.GcnMain_ConnectionString
        End If
    ...
    Public Sub FOpenConnection(ByVal StrCompanyCode As String, Optional ByVal StrSiteCode As String = "", Optional ByVal CheckKiller As Boolean = True)
        ...
        Try
            ...
            If DTTemp.Rows.Count > 0 Then
                ...
                DTTemp.Clear()
                ADTempSQL = New SQLiteDataAdapter("Select GetDate() As SrvDate ", Agl.ECompConn)
        ...
        Try
            If SiteCodeStr.Trim <> "" Then
                mQry = "Select S.*, C.CityName, " & _
                        " Case IfNull(S.Ho_Yn,'N') When 'N' Then 0 When '' Then 0 Else 1 End As IsHO, " & _
