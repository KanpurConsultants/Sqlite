Public Class ClsFunction
    ...
    Dim CRepProcOld As ClsReportProceduresOld
    ...
    Public Function FOpen(ByVal StrSender As String, ByVal StrSenderText As String, Optional ByVal IsEntryPoint As Boolean = True)
        ...
        If IsEntryPoint Then
            Select Case StrSender
                ...
                Case MDI.MnuUpdatePointValue.Name
                    AgL.Dman_ExecuteNonQry("exec UpdatePointValue", AgL.GCn)
                    MsgBox("Points updated successfully")
                Case MDI.MnuSendInvoiceSms.Name
        ...
        Else
            ...
            CRepProcOld = New ClsReportProceduresOld(ObjRepFormGlobal)
            CRepProcOld.GRepFormName = Replace(Replace(StrSenderText, "&", ""), " ", "")
            CRepProcOld.Ini_Grid()
