...
#Region "Public Help Queries"
    ...
    Public Const PubStrHlpQryWashingType As String = "Select 'Normal' as Code, 'Normal' as Description " &
                                                     " Union All Select 'Antique' as Code, 'Antique' as Description " &
                                                     " Union All Select 'Herbal' as Code, 'Herbal' as Description " &
...
#Region " Structure Update Code "
    ...
    Sub FIni_ItemType()
        ...
        strData = "Insert Into ItemType (Code,Name ) " +
                  "( " & strData & ") x "
...
#End Region
    ...
    Public Shared Sub FGetItemRate(ByVal ItemCode As String, ByVal RateType As String, ByVal V_Date As String,
        ...
        Try
            ...
            Else
                mQry = " SELECT  L.Rate FROM RateListDetail L WHERE L.Item = '" & ItemCode & "'  AND IfNull(L.RateType,'') = '" & RateType & "' And WEF <= '" & CDate(V_Date).ToString("u") & "'  ORDER BY L.WEF DESC Limit 1"
