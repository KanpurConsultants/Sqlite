...
#Region "Form Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.BtnFillPurchInvoice.ForeColor = System.Drawing.Color.Black
        Me.BtnFillPurchInvoice.Location = New System.Drawing.Point(723, 131)
        Me.BtnFillPurchInvoice.Margin = New System.Windows.Forms.Padding(0)
        Me.BtnFillPurchInvoice.Name = "BtnFillPurchInvoice"
        Me.BtnFillPurchInvoice.Size = New System.Drawing.Size(30, 23)
        ...
        Me.GrpDirectInvoice.Size = New System.Drawing.Size(454, 26)
        ...
        Me.RbtReturnForInvoice.Location = New System.Drawing.Point(290, 7)
        Me.RbtReturnForInvoice.Name = "RbtReturnForInvoice"
        Me.RbtReturnForInvoice.Size = New System.Drawing.Size(147, 17)
        Me.RbtReturnForInvoice.TabIndex = 1
        Me.RbtReturnForInvoice.TabStop = True
        Me.RbtReturnForInvoice.Text = "Return For Invoice"
...
#End Region
    ...
    Private Sub FrmPurchReturn_BaseFunction_IniGrid() Handles Me.BaseFunction_IniGrid
        ...
        With AgCL
            ...
            .AddAgTextColumn(Dgl1, Col1PurchInvoice, 70, 0, Col1PurchInvoice, True, True)
    ...
    Private Sub FrmPurchReturn_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As SQLiteConnection, ByVal Cmd As SQLiteCommand) Handles Me.BaseEvent_Save_InTrans
            ...
            If Dgl1.Item(Col1Item, I).Value <> "" Then
                If Dgl1.Item(ColSNo, I).Tag Is Nothing And Dgl1.Rows(I).Visible = True Then
                    ...
                    bSelectionQry += " Select " & AgL.Chk_Text(mSearchCode) & ", " & mSr & ", " &
                                        ...
                                        " " & AgL.Chk_Text(Dgl1.Item(Col1PurchInvoice, I).Tag) & ", " &
                                        " " & Val(Dgl1.Item(Col1PurchInvoiceSr, I).Value) & ", " &
                                        ...
                                        " '" & IIf(RbtReturnForInvoice.Checked, RbtReturnForInvoice.Text, IIf(RbtnRetunForChallan.Checked, RbtnRetunForChallan.Text, RbtReturnDirect.Text)) & "', " &
                ...
                Else
                    If Dgl1.Rows(I).Visible = True Then
                        If Dgl1.Rows(I).DefaultCellStyle.BackColor <> AgTemplate.ClsMain.Colours.GridRow_Locked Then
                            mQry = "UPDATE PurchInvoiceDetail SET " &
                                        " PurchChallan = " & AgL.Chk_Text(Dgl1.Item(Col1PurchChallan, I).Tag) & ", " &
                                        " PurchChallanSr = " & Val(Dgl1.Item(Col1PurchChallanSr, I).Value) & ", " &
                                        " PurchInvoice = " & AgL.Chk_Text(Dgl1.Item(Col1PurchInvoice, I).Tag) & ", " &
                                        " PurchInvoiceSr = " & Val(Dgl1.Item(Col1PurchInvoiceSr, I).Value) & ", " &
                                        ...
                                        " V_Nature = '" & IIf(RbtReturnForInvoice.Checked, RbtReturnForInvoice.Text, IIf(RbtnRetunForChallan.Checked, RbtnRetunForChallan.Text, RbtReturnDirect.Text)) & "', " &
        ...
        If bSelectionQry <> "" Then
            mQry = "INSERT INTO PurchInvoiceDetail (DocId, Sr, PurchChallan, PurchChallanSr, PurchInvoice, PurchInvoiceSr, " &
                    ...
                    " Rate, Amount, Remark, BillingType, T_Nature, Deal, V_Nature, " & AgCalcGrid1.FLineTableFieldNameStr() & ") " & bSelectionQry
            AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)
        End If
        ...
        mQry = " INSERT INTO  Stock(DocID, Sr, V_Type, V_Prefix, V_Date, V_No, Div_Code, Site_Code,   " &
                ...
                " L.Remark, H.ReferenceNo, L.PurchInvoice, L.PurchInvoiceSr, L.ExpiryDate " &
                " FROM PurchInvoiceDetail L  " &
    ...
    Private Sub FrmPurchReturn_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        mQry = "Select H.*, Sg.DispName As VendorDispName, C.Description As CurrencyDesc " &
        ...
        With DsTemp.Tables(0)
            If .Rows.Count > 0 Then
                ...
                mQry = " Select L.*, I.Description As ItemDesc, I.ManualCode, " &
                        ...
                        " LEFT JOIN PurchInvoice PI On L.PurchInvoice = PI.DocId " &
                ...
                With DsTemp.Tables(0)
                    ...
                    If .Rows.Count > 0 Then
                        For I = 0 To DsTemp.Tables(0).Rows.Count - 1
                            ...
                            Dgl1.Item(Col1PurchInvoice, I).Tag = AgL.XNull(.Rows(I)("PurchInvoice"))
                            Dgl1.Item(Col1PurchInvoice, I).Value = AgL.XNull(.Rows(I)("InvoiceRefNo"))
                            ...
                            If AgL.XNull(.Rows(I)("V_Nature")) = RbtReturnForInvoice.Text Then
                                RbtReturnForInvoice.Checked = True
                            ElseIf AgL.XNull(.Rows(I)("V_Nature")) = RbtnRetunForChallan.Text Then
        ...
        Try
            Select Case sender.NAME
                ...
                Case TxtVendor.Name
                    ...
                    End If
                    BtnFillPurchInvoice.Tag = Nothing
    ...
    Private Sub ProcFillItemsForInvoice(ByVal bInvoiceNoStr As String)
        ...
        Try
            ...
            mQry = "SELECT Max(L.Item) As Item, Max(I.Description) as ItemDesc, " &
                   ...
                   " Max(L.SalesTaxGroupItem) SalesTaxGroupItem, L.PurchInvoice, L.PurchInvoiceSr, " &
                   " Max(L.PurchChallan) AS PurchChallan, " &
                   " Max(L.PurchChallanSr) AS PurchChallanSr, " &
                   " Max(H.V_Type || '-' || H.ReferenceNo) As PurchInvoiceNo, " &
                   " Max(C.V_Type || '-' || C.ReferenceNo) As PurchChallanNo, " &
                   ...
                   " WHERE L.PurchInvoice In (" & bInvoiceNoStr & ") " & bCondStr &
            ...
            With DtTemp
                ...
                If .Rows.Count > 0 Then
                    For I = 0 To .Rows.Count - 1
                        ...
                        Dgl1.Item(Col1PurchInvoice, I).Tag = AgL.XNull(.Rows(I)("PurchInvoice"))
                        Dgl1.Item(Col1PurchInvoice, I).Value = AgL.XNull(.Rows(I)("PurchInvoiceNo"))
                        Dgl1.Item(Col1PurchInvoiceSr, I).Value = AgL.XNull(.Rows(I)("PurchInvoiceSr"))
    ...
    Private Sub ProcFillItemsForChallan(ByVal bChallanNoStr As String)
        ...
        Try
            ...
            mQry = " SELECT L.PurchChallan, L.PurchChallanSr, Max(H.V_Type) || '-' ||  Max(H.ReferenceNo) AS PurchChallanNo, max(H.V_Date) AS Challan_Date, " &
                    " max(PI.DocId) AS PurchInvoice, max(PI.V_Date) AS Invoice_Date,  Max(PI.V_Type || '-' || PI.ReferenceNo) As PurchInvoiceNo, Max(PID.Sr) As PurchInvoiceSr, " &
                    ...
                    " LEFT JOIN PurchInvoiceDetail PID ON IfNull(L.Docid,'') = IfNull(PID.PurchChallan,'')  AND IfNull(PID.PurchChallanSr,'') = IfNull(L.Sr,'')  " &
                    " LEFT JOIN PurchInvoice PI ON PID.DocId = PI.DocId " &
                    " LEFT JOIN Voucher_Type VT ON Vt.V_Type = PI.V_Type " &
    ...
    Private Sub BtnFillPurchInvoice_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnFillPurchInvoice.Click
        Try
            If Topctrl1.Mode = "Browse" Then Exit Sub
            Dim StrTicked As String

            If RbtReturnForInvoice.Checked = True Then
                StrTicked = FHPGD_PendingPurchInvoiceNo()
            ElseIf RbtnRetunForChallan.Checked = True Then
    ...
    Private Function FHPGD_PendingPurchInvoiceNo() As String
        ...
        mQry = " SELECT 'o' As Tick, L.PurchInvoice, Max(H.V_Type) || '-' ||  Max(H.ReferenceNo) AS Invoice_No, " &
        ...
        End If
        FHPGD_PendingPurchInvoiceNo = StrRtn
                    ...
                    If Dgl1.AgHelpDataSet(Col1ItemCode) Is Nothing Then
                        If RbtReturnForInvoice.Checked Then
                            mQry = " SELECT Max(L.Item) As Item, Max(I.ManualCode) AS ItemCode, Max(I.Description) AS ItemDesc, " &
                                   ...
                                   " LEFT JOIN Unit U On L.Unit = U.Code " &
                                   " LEFT JOIN Unit U1 On L.MeasureUnit = U1.Code " &
                                   " WHERE L.DocId <> '" & mSearchCode & "' AND IfNull(I.ManualCode,'') <> '' " & bCondStr &
                                   " GROUP BY L.PurchInvoice, L.PurchInvoiceSr " &
                                   " Having IfNull(Sum(L.Qty),0) > 0  "
                            Dgl1.AgHelpDataSet(Col1ItemCode, 15) = AgL.FillData(mQry, AgL.GCn)
                        ElseIf RbtnRetunForChallan.Checked Then
                            mQry = " SELECT  max(L.Item) AS Item, Max(I.ManualCode) AS ItemManualCode, Max(I.Description) as ItemDesc,  L.PurchChallan, L.PurchChallanSr, Max(H.V_Type) || '-' ||  Max(H.ReferenceNo) AS PurchChallanNo, max(H.V_Date) AS Challan_Date, " &
                                    " max(PI.DocId) AS PurchInvoice, max(PI.V_Date) AS Invoice_Date,  Max(PI.V_Type || '-' || PI.ReferenceNo) As Invoice_No, Max(PID.Sr) As PurchInvoiceSr, " &
                        ...
                        Else
                            mQry = "SELECT I.Code As Item, I.ManualCode As ItemManualCode, I.Description As ItemDesc, " &
                                      ...
                                      " '' As PurchInvoice, 0 As PurchInvoiceSr, " &
                    ...
                    If Dgl1.AgHelpDataSet(Col1Item) Is Nothing Then
                        If RbtReturnForInvoice.Checked Then
                            mQry = "SELECT Max(L.Item) As Item, Max(I.Description) as ItemDesc, " &
                                   ...
                                   " LEFT JOIN Unit U On L.Unit = U.Code " &
                                   " LEFT JOIN Unit U1 On L.MeasureUnit = U1.Code " &
                                   " WHERE L.DocId <> '" & mSearchCode & "' " & bCondStr &
                                   " GROUP BY L.PurchInvoice, L.PurchInvoiceSr " &
                                   " Having IfNull(Sum(L.Qty),0) > 0  "
        ...
        Try
            ...
            Else
                If Dgl1.AgDataRow IsNot Nothing Then
                    ...
                    Dgl1.Item(Col1PurchInvoice, mRow).Tag = AgL.XNull(Dgl1.AgDataRow.Cells("PurchInvoice").Value)
                    Dgl1.Item(Col1PurchInvoice, mRow).Value = AgL.XNull(Dgl1.AgDataRow.Cells("Invoice_No").Value)
                    Dgl1.Item(Col1PurchInvoiceSr, mRow).Value = AgL.XNull(Dgl1.AgDataRow.Cells("PurchInvoiceSr").Value)
    ...
    Private Sub TxtCurrency_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TxtCurrency.KeyDown, TxtVendor.KeyDown, TxtSalesTaxGroupParty.KeyDown
        Try
            If AgL.StrCmp(Topctrl1.Mode, "Browse") Then Exit Sub
            Select Case sender.name
    ...
    Private Sub RbtnRetunForChallan_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles RbtnRetunForChallan.Click, RbtReturnDirect.Click, RbtReturnForInvoice.Click
        If Dgl1.AgHelpDataSet(Col1Item) IsNot Nothing Then Dgl1.AgHelpDataSet(Col1Item) = Nothing
    End Sub

    Private Sub FrmPurchReturn_BaseEvent_Topctrl_tbPrn(ByVal SearchCode As String) Handles Me.BaseEvent_Topctrl_tbPrn
