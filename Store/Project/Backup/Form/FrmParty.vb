...
#End Region
    ...
    Private Sub FrmParty_BaseEvent_Topctrl_tbAdd() Handles Me.BaseEvent_Topctrl_tbAdd
        ...
        TxtManualCode.Text = AgL.XNull(AgL.Dman_Execute("Select IsNull(Max(Convert(Numeric,I.ManualCode)),0)+1 AS ManualCode FROM SubGroup I With (NoLock) WHERE isnumeric(I.ManualCode)>0", AgL.GCn).ExecuteScalar)
