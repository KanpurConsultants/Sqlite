...
#Region "Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.Label1.Location = New System.Drawing.Point(295, 120)
        ...
        Me.TxtDescription.Location = New System.Drawing.Point(311, 112)
        ...
        Me.LblDescription.Location = New System.Drawing.Point(173, 113)
...
#End Region
    ...
    Private Sub FrmYarn_BaseEvent_Data_Validation(ByRef passed As Boolean) Handles Me.BaseEvent_Data_Validation
        ...
        If Topctrl1.Mode = "Add" Then
            mQry = "Select count(*) From Dimension2 Where Description='" & TxtDescription.Text & "' "
            If AgL.Dman_Execute(mQry, AgL.GCn).ExecuteScalar > 0 Then Err.Raise(1, , "Description Already Exist!")
        Else
            mQry = "Select count(*) From Dimension2 Where Description='" & TxtDescription.Text & "' And Code <> '" & mInternalCode & "' "
            If AgL.Dman_Execute(mQry, AgL.GCn).ExecuteScalar > 0 Then Err.Raise(1, , "Description Already Exist!")
        End If
    End Sub
    ...
    Public Overridable Sub FrmYarn_BaseEvent_FindMain() Handles Me.BaseEvent_FindMain
        ...
        AgL.PubFindQry = "SELECT I.Code As SearchCode, I.Description  From Dimension2 I "
        AgL.PubFindQryOrdBy = "[Description]"
    End Sub

    Private Sub FrmYarn_BaseEvent_Form_PreLoad() Handles Me.BaseEvent_Form_PreLoad
        MainTableName = "Dimension2"
        LogTableName = "Dimension2_Log"
    End Sub
    ...
    Private Sub FrmDimension2_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Function FGetRelationalData() As Boolean
        Try
            mQry = " Select Count(*) From SubGroup Where Dimension2 = '" & mSearchCode & "'"
            If AgL.VNull(AgL.Dman_Execute(mQry, AgL.GCn).ExecuteScalar) > 0 Then
                MsgBox(" Data Exists For Dimension2 " & TxtDescription.Text & " In Employee Master . Can't Delete Entry", MsgBoxStyle.Information)
