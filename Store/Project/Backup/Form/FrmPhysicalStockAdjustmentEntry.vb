...
#End Region
    ...
    Private Sub FrmProductionOrder_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_Save_InTrans
            ...
            For I = 0 To .RowCount - 1
                If .Item(Col1Item, I).Value <> "" Then
                    ...
                    mQry = "INSERT INTO StockHeadDetail(DocId, Sr, Item, Process, " & _
                            ...
                            " DifferenceQty, DifferenceMeasure, ReferenceDocId) " & _
                            ...
                            " " & AgL.Chk_Text(.Item(Col1ReferenceDocId, I).Value) & " " & _
                            " ) "
                    AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)
                End If
            Next
        ...
        mQry = " UPDATE StockHead " & _
                ...
                " Where StockHead.V_Type = '" & AgL.XNull(DtV_TypeSettings.Rows(0)("FilterInclude_ContraV_Type")) & "'   " & _
    ...
    Private Function FFillPendingChallans() As String
        ...
        mQry = " SELECT DISTINCT 'o' As Tick, H.V_Date " & _
                    " FROM StockHead H " & _
                    " LEFT JOIN Voucher_Type Vt ON H.V_Type = Vt.V_Type " & _
                    " WHERE Vt.V_Type = '" & AgL.XNull(DtV_TypeSettings.Rows(0)("FilterInclude_ContraV_Type")) & "'   " & _
    ...
    Private Function FRetItemStock(ByVal mRow As Integer) As Double
        Try
            mQry = " SELECT IsNull(Sum(Qty_Rec),0) - IsNull(Sum(Qty_Iss),0) " & _
                    " FROM Stock " & _
                    " WHERE Item = '" & Dgl1.Item(Col1Item, mRow).Tag & "' " & _
                    " And V_Date <= '" & TxtV_Date.Text & "'   " & _
                    " And Unit = '" & Dgl1.Item(Col1Unit, mRow).Value & "'" & _
                    " And Godown = '" & TxtGodown.Tag & "' " & _
                    " And Site_Code = '" & AgL.PubSiteCode & "' " & _
