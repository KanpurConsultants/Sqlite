...
#End Region
    ...
    Private Function FGetRelationalData() As Boolean
        Try
            mQry = " Select Count(*) From SubGroup Where Dimension1 = '" & mSearchCode & "'"
            If AgL.VNull(AgL.Dman_Execute(mQry, AgL.GCn).ExecuteScalar) > 0 Then
                MsgBox(" Data Exists For Dimension1 " & TxtDescription.Text & " In Employee Master . Can't Delete Entry", MsgBoxStyle.Information)
