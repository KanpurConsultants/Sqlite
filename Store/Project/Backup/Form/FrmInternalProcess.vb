...
#End Region
    ...
    Private Sub FrmInternalProcess_BaseEvent_ApproveDeletion_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_ApproveDeletion_InTrans
    ...
    Private Sub FrmProductionOrder_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_Save_InTrans
        ...
        mQry = "UPDATE StockHead " & _
                " SET " & _
                " TotalQty = " & Val(LblTotalIssuedQty.Text) & ", " & _
                " TotalMeasure = " & Val(LblTotalIssuedMeasure.Text) & ", " & _
        ...
        For I = 0 To Dgl2.RowCount - 1
            If Dgl2.Item(Col2Item, I).Value <> "" Then
                ...
                mQry = " INSERT INTO StockHeadDetail ( DocID, Sr, Item_UID, Item, Dimension1, Dimension2, Specification, LotNo, BaleNo, Godown, Qty, Unit, " & _
                        " MeasurePerPcs, TotalMeasure, MeasureUnit, Rate, Amount, Remarks, " & _
                        " CurrentStock, V_Nature, CostCenter) " & _
                        " VALUES (" & AgL.Chk_Text(mSearchCode) & ", " & _
                        " " & mSr & ", " & _
                        " " & AgL.Chk_Text(Dgl2.Item(Col2Item_UID, I).Tag) & ", " & _
                        " " & AgL.Chk_Text(Dgl2.AgSelectedValue(Col2Item, I)) & ", " & _
                        " " & AgL.Chk_Text(Dgl2.Item(Col2Dimension1, I).Tag) & ", " & _
                        " " & AgL.Chk_Text(Dgl2.Item(Col2Dimension2, I).Tag) & ", " & _
                        " " & AgL.Chk_Text(Dgl2.Item(Col2Specification, I).Value) & ",  " & _
                        " " & AgL.Chk_Text(Dgl2.Item(Col2LotNo, I).Value) & ",  " & _
                        " " & AgL.Chk_Text(Dgl2.Item(Col2BaleNo, I).Value) & ",  " & _
                        " " & AgL.Chk_Text(TxtFromGodown.AgSelectedValue) & ", " & _
                        " " & Val(Dgl2.Item(Col2Qty, I).Value) & ", " & _
                        " " & AgL.Chk_Text(Dgl2.Item(Col2Unit, I).Value) & ",  " & _
                        " " & Val(Dgl2.Item(Col2MeasurePerPcs, I).Value) & ", " & _
                        " " & Val(Dgl2.Item(Col2TotalMeasure, I).Value) & ", " & AgL.Chk_Text(Dgl2.Item(Col2MeasureUnit, I).Value) & ", " & _
                        " " & Val(Dgl2.Item(Col2Rate, I).Value) & ", " & _
                        " " & Val(Dgl2.Item(Col2Amount, I).Value) & ", " & _
                        " " & AgL.Chk_Text(Dgl2.Item(Col2Remarks, I).Value) & ", " & _
                        " " & Val(Dgl2.Item(Col2CurrentStock, I).Value) & ", " & _
                        " " & AgL.Chk_Text(V_Nature_Receive) & ", " & _
                        " " & AgL.Chk_Text(Dgl2.Item(Col2CostCenter, I).Tag) & " " & _
                        " ) "
                AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)
            End If
        Next
        ...
        mQry = " INSERT INTO Stock (DocId, Sr, V_Type, V_Prefix, " & _
                ...
                " Select L.DocId, L.Sr, H.V_Type, H.V_Prefix, " & _
                " H.V_Date, H.V_No, H.ManualRefNo, H.Div_Code, H.Site_Code, H.SubCode, " & _
                " L.Item_UID, L.Item, L.Dimension1, L.Dimension2, L.Godown, L.Qty, 0, L.Unit, " & _
                " L.MeasurePerPcs, L.TotalMeasure, 0, L.MeasureUnit, " & _
                " L.Rate, L.Amount, L.Amount, L.Amount, L.LotNo, L.BaleNo, H.Process, L.CostCenter, L.Remarks " & _
                " From StockHead H " & _
                " LEFT JOIN StockHeadDetail L On H.DocId = L.DocId " & _
                " Where H.DocId = '" & mSearchCode & "' " & _
                " And L.V_Nature <> '" & V_Nature_Receive & "'" & _
                " UNION ALL " & _
                " Select L.DocId, L.Sr, H.V_Type, H.V_Prefix, " & _
                " H.V_Date, H.V_No, H.ManualRefNo, H.Div_Code, H.Site_Code, H.SubCode, " & _
                " L.Item_UID, L.Item, L.Dimension1, L.Dimension2, L.Godown, 0, L.Qty, L.Unit, " & _
                " L.MeasurePerPcs, 0, L.TotalMeasure, L.MeasureUnit, " & _
                " L.Rate, L.Amount, L.Amount, L.Amount, L.LotNo, L.BaleNo, H.Process, L.CostCenter, L.Remarks " & _
                " From StockHead H " & _
                " LEFT JOIN StockHeadDetail L On H.DocId = L.DocId " & _
                " Where H.DocId = '" & mSearchCode & "' " & _
        ...
        With DsTemp.Tables(0)
            If .Rows.Count > 0 Then
                ...
                mQry = "Select S.*, I.ManualCode as Item_No, I.Description as Item_Desc, R.ReferenceNo AS ReqNo, " & _
                       ...
                       "P.Description as Process_Desc, C.Name As CostCenterName, " & _
                       "D1.Description As Dimension1Desc, D2.Description As Dimension2Desc " & _
                       "From (Select * From StockHeadDetail Where DocId = '" & SearchCode & "' And V_Nature <> '" & V_Nature_Receive & "') S " & _
                       ...
                       "LEFT JOIN CostCenterMast C On S.CostCenter = C.Code " & _
                       "Order By Sr"
                DsTemp = AgL.FillData(mQry, AgL.GCn)
                With DsTemp.Tables(0)
                    Dgl1.RowCount = 1
    ...
    Private Sub FCreateHelpLotNo()
        ...
        If AgL.VNull(AgL.Dman_Execute("Select Max(Convert(INT,IsRequired_LotNo)) From ItemSiteDetail L Where Code = '" & Dgl1.Item(Col1Item, Dgl1.CurrentCell.RowIndex).Tag & "' ", AgL.GcnRead).ExecuteScalar) <> 0 Then
            mQry = " SELECT L.LotNo As Code, Max(L.LotNo) As LotNo, Max(I.Description) As ItemDesc, " & _
                    " Round(IsNull(Sum(L.Qty_Rec),0) - IsNull(Sum(L.Qty_Iss),0),3) AS Qty " & _
                    " FROM Stock L " & _
                    " LEFT JOIN Item I ON L.Item = I.Code " & _
                    " Where L.LotNo Is Not Null AND L.Item = '" & Dgl1.Item(Col1Item, Dgl1.CurrentCell.RowIndex).Tag & "' " & _
                    " And IsNull(I.Status,'" & AgTemplate.ClsMain.EntryStatus.Active & "') <= '" & AgTemplate.ClsMain.EntryStatus.Active & "' " & _
                    " Group By L.Item, L.LotNo, L.Process " & _
                    " Having Round(IsNull(Sum(L.Qty_Rec),0) - IsNull(Sum(L.Qty_Iss),0),3)  > 0 " & _
                    " Order By LotNo, Item "
    ...
    Private Sub Validating_Received_Item_Uid(ByVal Item_Uid As String, ByVal mRow As Integer)
        ...
        Try
            mQry = " SELECT I.Code, I.Description, I.Unit, I.ManualCode, I.Prod_Measure, I.MeasureUnit, I.Rate, " & _
                   " U.DecimalPlaces as QtyDecimalPlaces, MU.DecimalPlaces as MeasureDecimalPlaces, UI.Code as ItemUIDCode, UI.ProdOrder as ProdOrderDocID, PO.V_Type + '-' + PO.ManualRefNo as ProdOrderNo  " & _
                   " FROM (Select Item, Code, ProdOrder From Item_UID Where Item_Uid = '" & Dgl2.Item(Col2Item_UID, mRow).Value & "') UI " & _
                   " Left Join ProdOrder PO With (NoLock) On UI.ProdOrder = PO.DocID " & _
                   " Left Join Item I With (NoLock) On UI.Item  = I.Code " & _
                   " Left Join Unit U With (NoLock) On I.Unit = U.Code " & _
                   " Left Join Unit MU With (NoLock) On I.MeasureUnit = MU.Code "
        ...
        Select Case ColumnName
            Case Col1Item
                mQry = " SELECT I.Code AS Item, I.Description AS ItemDesc, I.ManualCode AS ItemCode, I.Unit, " & _
                        " I.Measure AS MeasurePerPcs, I.MeasureUnit, U.DecimalPlaces as QtyDecimalPlaces, MU.DecimalPlaces as MeasureDecimalPlaces, I.Rate, 0 AS Qty " & _
                        " FROM Item I " & _
                        " Left Join Unit U On I.Unit = U.Code " & _
                        " Left Join Unit MU On I.MeasureUnit = MU.Code " & _
            ...
            Case Col1ItemCode
                mQry = " SELECT H.Code, H.ManualCode as Item_No, H.Description as Item_Name, H.Unit, " & _
                        " H.Measure, H.MeasureUnit, U.DecimalPlaces as QtyDecimalPlaces, MU.DecimalPlaces as MeasureDecimalPlaces, H.Rate, 0 AS Qty " & _
                        " FROM Item H " & _
    ...
    Private Sub FrmStoreIssue_BaseEvent_Topctrl_tbPrn(ByVal SearchCode As String) Handles Me.BaseEvent_Topctrl_tbPrn
        ...
        mSubQry = "Select S.Sr, S.Qty, S.Unit, S.Remarks, I.ManualCode as Item_No, I.Description as Item_Desc, " & _
                       "U.DecimalPlaces as QtyDecimalPlaces, MU.DecimalPlaces as MeasureDecimalPlaces, " & _
                       "P.Description as Process_Desc, C.Name As CostCenterName " & _
                       "from (Select * From StockHeadDetail where DocId = '" & SearchCode & "' And V_Nature = '" & V_Nature_Receive & "') S " & _
                       "Left Join Item I On S.Item = I.Code " & _
    ...
    Private Sub ProcFillRequisitionDetails(ByVal bRequisitionStr As String)
        ...
        Try
            ...
            '        " ISNULL(Max(U.DecimalPlaces),0) As QtyDecimalPlaces, ISNULL(Max(UM.DecimalPlaces),0) As MeasureDecimalPlaces, max(L.MeasureUnit) AS MeasureUnit, '" & RbtIssueForStock.Text & "' AS V_Nature " & _
            '        " FROM Requisition H " & _
            '        " LEFT JOIN RequisitionDetail L ON L.DocId = H.DocID " & _
            '        " LEFT JOIN Item I ON I.Code = L.Item  " & _
            '        " LEFT JOIN Unit U ON U.Code = L.Unit  " & _
