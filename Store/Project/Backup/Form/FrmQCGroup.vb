...
#End Region
    ...
    Private Sub FrmShade_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_Save_InTrans
        ...
        mQry = "Delete From QcGroupDetail Where Code = '" & SearchCode & "'"
        ...
        With Dgl1
            For I = 0 To .RowCount - 1
                If .Item(Col1Parameter, I).Value <> "" Then
                    mSr += 1
                    mQry = " INSERT INTO QcGroupDetail (Code, Sr, Parameter, StdValue ) " & _
                            " VALUES (" & AgL.Chk_Text(mInternalCode) & "," & mSr & "," & _
                            " " & AgL.Chk_Text(Dgl1.Item(Col1Parameter, I).Value) & ", " & AgL.Chk_Text(Dgl1.Item(Col1StdValue, I).Value) & " ) "
                    AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)
                End If
            Next
        End With
    ...
    Private Sub TempQCGroup_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        AgL.WinSetting(Me, 480, 870, 0, 0)
    End Sub

    Private Sub TempQCGroup_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles Me.Paint
