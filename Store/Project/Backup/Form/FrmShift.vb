...
#End Region
    ...
    Private Sub FrmShift_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_Save_InTrans
        mQry = "UPDATE Shift " & _
                " SET " & _
                " Description = " & AgL.Chk_Text(TxtDescription.Text) & ", " & _
                " FromTime = " & Val(TxtFromTime.Text) & ", " & _
                " ToTime = " & Val(TxtToTime.Text) & ", " & _
                " LunchFromTime = " & Val(TxtLunchFromTime.Text) & ", " & _
                " LunchToTime = " & Val(TxtLunchToTime.Text) & " " & _
