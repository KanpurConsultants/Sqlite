...
#End Region
    ...
    Public Overridable Sub FrmYarn_BaseEvent_FindMain() Handles Me.BaseEvent_FindMain
        ...
        AgL.PubFindQry = "SELECT I.Code, I.Description as Item_Rate_Group  " & _
                        " FROM Item I  " & mConStr
    ...
    Private Sub FrmYarn_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As System.Data.SqlClient.SqlConnection, ByVal Cmd As System.Data.SqlClient.SqlCommand) Handles Me.BaseEvent_Save_InTrans
        mQry = "UPDATE Item " & _
                ...
                " ProcessList = " & AgL.Chk_Text(TxtProcessList.Tag) & ", " & _
                " ItemType = " & AgL.Chk_Text(AgTemplate.ClsMain.ItemType.ItemRateGroup) & " " & _
    ...
    Private Sub FrmQuality1_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        With DsTemp.Tables(0)
            If .Rows.Count > 0 Then
                ...
                mQry = "DECLARE @temp NVARCHAR(1000) " & _
                     "SET @temp=''  " & _
                     "select @temp= @temp + Process.Description + ',' from Process  where CharIndex('|' + NCat + '|','" & AgL.XNull(.Rows(0)("ProcessList")) & "' ) > 0  " & _
    ...
    Private Function FHPGD_ProcessList() As String
        ...
        mQry = " SELECT 'o' As Tick, H.NCat, H.Description " & _
                " FROM Process H  " & _
                    ...
                    If e.KeyCode <> Keys.Enter Then
                        If TxtDescription.AgHelpDataSet Is Nothing Then
                            mQry = "Select Code, Description As Name " & _
                                  " From Item " & _
                                  " Where ItemType = '" & AgTemplate.ClsMain.ItemType.ItemRateGroup & "'" & _
