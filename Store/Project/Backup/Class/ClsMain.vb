    ...
    Public Shared Function FIsNegativeStock(ByVal mSelectionQry As String, ByVal SearchCode As String, ByVal Godown As String, ByVal V_Date As String) As Boolean
        ...
        If AgL.VNull(DtGodownSettings.Rows(0)("RestrictNegetiveStock")) <> 0 Or AgL.VNull(DtGodownSettings.Rows(0)("AlertOnNegetiveStock")) <> 0 Then
            ...
            mQry = "CREATE TABLE [#" & bTempTable & "] " & _
                  ...
                  " Dimension1 nVarchar(100), " & _
                  " Dimension2 nVarchar(100), " & _
            ...
            mItemInTransactionQry = " Select L.Item, " & _
                            ...
                            " L.Dimension1, L.Dimension2, L.Process, " & _
                            " Sum(L.Qty) As Qty " & _
                            ...
                            " Group By L.Item, Case When IsNull(Isd.IsRequired_LotNo,0) <> 0 Then L.LotNo ELse Null End, L.Dimension1, L.Dimension2, L.Process "
            ...
            mTillTransactionDateStockQry = " Select S.Item, " & _
                                ...
                                " S.Dimension1, S.Dimension2, S.Process, " & _
                                " IsNull(Sum(S.Qty_Rec),0) - IsNull(Sum(S.Qty_Iss),0) As TillTransactionDateStock " & _
                                " From (Select DocId, Godown, V_Date, Item, LotNo, Dimension1, Dimension2, Process, Qty_Rec, Qty_Iss From Stock Where Item In (Select Item COLLATE DATABASE_DEFAULT From [#" & bTempTable & "])) As S " & _
                                ...
                                " Group By S.Item, Case When IsNull(Isd.IsRequired_LotNo,0) <> 0 Then S.LotNo ELse Null End ,S.Dimension1, S.Dimension2, S.Process "
            ...
            mCurrentStockQry = " Select S.Item, " & _
                    ...
                    " From (Select DocId, Godown, V_Date, Unit, Item, LotNo, Dimension1, Dimension2, Process, Qty_Rec, Qty_Iss From Stock Where Item In (Select Item COLLATE DATABASE_DEFAULT From [#" & bTempTable & "])) As S " & _
                    " LEFT JOIN (Select Code, IsRequired_LotNo From ItemSiteDetail Where Site_Code = '" & AgL.PubSiteCode & "') As Isd ON S.Item = Isd.Code  COLLATE DATABASE_DEFAULT " & _
            ...
            mQry = " Select H.Item, H.LotNo, I.Description As ItemDesc, " & _
                    " D1.Description As Dimension1Desc, D2.Description As Dimension2Desc, P.Description As ProcessDesc, " & _
                    " IsNull(H.Qty,0) As Qty, Round(IsNull(L.CurrentStock,0),isnull(U.Decimalplaces,0)) As Stock " & _
                    ...
                    " LEFT JOIN Dimension1 D1 On H.Dimension1 = D1.Code COLLATE DATABASE_DEFAULT " & _
                    " LEFT JOIN Dimension2 D2 On H.Dimension2 = D2.Code COLLATE DATABASE_DEFAULT " & _
            ...
            If DtTemp.Rows.Count > 0 Then
                ...
                Next
            Else
                mQry = " Select H.Item, L.LotNo, I.Description As ItemDesc, IsNull(H.Qty,0) As Qty, " & _
                        " D1.Description As Dimension1Desc, D2.Description As Dimension2Desc, P.Description As ProcessDesc, " & _
                        " Round(IsNull(L.TillTransactionDateStock,0),isnull(U.Decimalplaces,0)) As Stock " & _
                        " From (" & mItemInTransactionQry & ") As H " & _
