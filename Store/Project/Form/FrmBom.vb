...
#End Region
    ...
    Private Sub FrmYarn_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As SqliteConnection, ByVal Cmd As SqliteCommand) Handles Me.BaseEvent_Save_InTrans
        ...
        mQry = " UPDATE Item SET " &
                " Description = " & AgL.Chk_Text(TxtItem.Text) & ", " &
                " ItemType = " & AgL.Chk_Text(ClsMain.ItemType.BOM) & ", " &
                " Unit = " & AgL.Chk_Text(TxtProdBatchUnit.Text) & ", " &
                " ProdBatchQty = " & Val(TxtProdBatchQty.Text) & ", " &
                " ProdBatchUnit = " & AgL.Chk_Text(TxtProdBatchUnit.Text) & " " &
        ...
        For I = 0 To DGL1.RowCount - 1
            If DGL1.Item(Col1BaseItem, I).Value <> "" Then
                mSr += 1
                mQry = " INSERT INTO BomDetail(Code, Sr, BaseItem, Process, IsMarkedForMainItem, " &
                        " Item, Qty, Unit, WastagePer ) " &
                        " VALUES (" & AgL.Chk_Text(mSearchCode) & ", " &
                        " " & mSr & ", " &
                        " " & AgL.Chk_Text(DGL1.Item(Col1BaseItem, I).Tag) & ", " &
                        " " & AgL.Chk_Text(DGL1.Item(Col1Process, I).Tag) & ", " &
                        " " & IIf(AgL.StrCmp(DGL1.Item(Col1IsMarkedForMainItem, I).Value, AgLibrary.ClsConstant.StrCheckedValue), 1, 0) & ", " &
                        " " & AgL.Chk_Text(DGL1.Item(Col1BaseItem, I).Tag) & ", " & Val(DGL1.Item(Col1Qty, I).Value) & " , " &
