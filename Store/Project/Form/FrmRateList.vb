...
#End Region
    ...
    Public Sub FrmYarn_BaseEvent_FindMain() Handles Me.BaseEvent_FindMain
        Dim mConStr$ = ""
        mConStr = "WHERE 1=1  "
        AgL.PubFindQry = "SELECT H.Code, P.Description As Process " &
                        " FROM RateList H " &
        ...
        With Dgl1
            For I = 0 To .RowCount - 1
                If .Item(Col1PartyRateGroup, I).Value <> "" Then
                    bSr += 1
                    mQry = "INSERT INTO RateListDetail(Code, Sr, Process, SubCode, Item, Rate) " &
                           " VALUES (" & AgL.Chk_Text(SearchCode) & ", " &
                           " " & bSr & ", " &
                           " " & AgL.Chk_Text(TxtProcess.Tag) & ", " &
                           " " & AgL.Chk_Text(Dgl1.Item(Col1PartyRateGroup, I).Tag) & ", " &
                           " " & AgL.Chk_Text(Dgl1.Item(Col1ItemRateGroup, I).Tag) & ", " &
    ...
    Private Sub FrmQuality1_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        With DsTemp.Tables(0)
            If .Rows.Count > 0 Then
                ...
                mQry = "Select L.*, I.Description As ItemRateGroupDesc, Sg.Name As PartyRateGroupDesc " &
