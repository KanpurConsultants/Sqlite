...
#End Region
    ...
    Private Sub FrmProductionOrder_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As SQLiteConnection, ByVal Cmd As SQLiteCommand) Handles Me.BaseEvent_Save_InTrans
        ...
        mQry = "UPDATE GatePass " &
                " SET " &
                " SubCode = " & AgL.Chk_Text(TxtSubCode.Tag) & ", " &
                " Godown = " & AgL.Chk_Text(TxtFromGodown.Tag) & ", " &
        ...
        For I = 0 To Dgl1.RowCount - 1
            If Dgl1.Item(Col1Item, I).Value <> "" Then
                mSr += 1
                mQry = " INSERT INTO dbo.GatePassDetail ( DocID, Sr, Item_UID, Item, Specification, LotNo, BaleNo, Qty, Unit, " &
                        " MeasurePerPcs, TotalMeasure, MeasureUnit, Remarks) " &
    ...
    Private Sub FrmProductionOrder_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        mQry = "Select H.*, G.Description as GodownDesc, P.Description as ProcessDesc, " &
        ...
        With DsTemp.Tables(0)
            If .Rows.Count > 0 Then
                ...
                mQry = "Select S.*, I.ManualCode as Item_No, I.Description as Item_Desc, Iu.Item_Uid As Item_UidDesc, " &
                       " U.DecimalPlaces as QtyDecimalPlaces, MU.DecimalPlaces as MeasureDecimalPlaces, IG.Description AS ItemGroupDesc " &
                       " from (Select * From GatePassDetail where DocId = '" & SearchCode & "') As S " &
        ...
        Select Case ColumnName
            Case Col1Item
                mQry = " SELECT I.Code AS Item, I.Description AS ItemDesc, I.ManualCode AS ItemCode, I.Unit, " &
                        " I.Measure AS MeasurePerPcs, I.MeasureUnit, U.DecimalPlaces as QtyDecimalPlaces, IG.Description AS ItemGroupDesc, MU.DecimalPlaces as MeasureDecimalPlaces " &
                        " FROM Item I " &
                        " LEFT JOIN ItemGroup IG On Ig.Code = I.ItemGroup" &
                        " Left Join Unit U On I.Unit = U.Code " &
                        " Left Join Unit MU On I.MeasureUnit = MU.Code " &
            ...
            Case Col1ItemCode
                mQry = " SELECT H.Code, H.ManualCode as Item_No, H.Description as Item_Name, H.Unit, " &
                        " H.Measure, H.MeasureUnit, U.DecimalPlaces as QtyDecimalPlaces, IG.Description AS ItemDesc, MU.DecimalPlaces as MeasureDecimalPlaces " &
                        " FROM Item H " &
    ...
    Private Sub FrmStoreIssue_BaseEvent_Topctrl_tbPrn(ByVal SearchCode As String) Handles Me.BaseEvent_Topctrl_tbPrn
        mQry = "Select H.DOCID, H.V_TYPE, H.V_DATE, H.V_NO, H.MANUALREFNO, H.REMARKS, H.ENTRYBY, H.ENTRYDATE, " &
                ...
                " S.NAME AS JOBWORKERNAME, S.DISPNAME AS JOBWORKERDISPNAME,   S.ADD1, S.ADD2,S.ADD3,C.CITYNAME,S.MOBILE,S.PHONE, S.PAN, " &
                " I.Description as Item_Desc, L.Sr, L.Qty, L.Unit, L.Remarks AS LineRemark, U.DecimalPlaces as QtyDecimalPlaces, " &
                " G.Description as GodownDesc, P.Description as ProcessDesc " &
                " From GatePass H  " &
                " LEFT JOIN GatePassDetail L ON L.DocID = H.DocID " &
                " Left Join Godown G on H.Godown = G.Code " &
