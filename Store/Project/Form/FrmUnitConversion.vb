...
#End Region
    ...
    Private Sub FrmYarn_BaseEvent_FindMain() Handles Me.BaseEvent_FindMain
        Dim mConStr$ = ""
        AgL.PubFindQry = " SELECT H.Code AS SearchCode,  H.FromUnit, H.ToUnit " &
    ...
    Private Sub FrmYarn_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As SqliteConnection, ByVal Cmd As SqliteCommand) Handles Me.BaseEvent_Save_InTrans
        mQry = "UPDATE UnitConversion " &
            " SET FromUnit = " & AgL.Chk_Text(TxtFromUnit.Text) & ", " &
            " ToUnit = " & AgL.Chk_Text(TxtToUnit.Text) & ", " &
            " Multiplier = " & Val(TxtMultiplier.Text) & ", " &
            " Rounding = " & Val(TxtRounding.Text) & " " &
