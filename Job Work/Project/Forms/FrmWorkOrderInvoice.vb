...
Public Class FrmWorkOrderInvoice
    ...
    Protected Const Col1WorkDispatch As String = "Work Dispatch"
    Protected Const Col1WorkDispatchSr As String = "Work Dispatch Sr"
...
#Region "Form Designer Code"
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FrmWorkOrderInvoice))
        ...
        Me.RbtForWorkReceive = New System.Windows.Forms.RadioButton
        ...
        Me.TxtCurrency.Location = New System.Drawing.Point(864, 46)
        ...
        'PnlCustomGrid
        '
        Me.PnlCustomGrid.Location = New System.Drawing.Point(384, 413)
        Me.PnlCustomGrid.Name = "PnlCustomGrid"
        Me.PnlCustomGrid.Size = New System.Drawing.Size(273, 157)
        ...
        Me.GrpDirectChallan.Controls.Add(Me.RbtForWorkReceive)
        ...
        'RbtForWorkReceive
        '
        Me.RbtForWorkReceive.AutoSize = True
        Me.RbtForWorkReceive.Font = New System.Drawing.Font("Verdana", 8.25!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        Me.RbtForWorkReceive.Location = New System.Drawing.Point(137, 7)
        Me.RbtForWorkReceive.Name = "RbtForWorkReceive"
        Me.RbtForWorkReceive.Size = New System.Drawing.Size(145, 17)
        Me.RbtForWorkReceive.TabIndex = 743
        Me.RbtForWorkReceive.TabStop = True
        Me.RbtForWorkReceive.Text = "For Work Dispatch"
        Me.RbtForWorkReceive.UseVisualStyleBackColor = True
        '
        'BtnFillWorkOrder
        '
        ...
        Me.BtnFillWorkOrder.Location = New System.Drawing.Point(518, 161)
        ...
        Me.TxtGodown.Size = New System.Drawing.Size(123, 18)
        ...
        Me.LblCurrency.Location = New System.Drawing.Point(773, 46)
        Me.LblCurrency.Name = "LblCurrency"
        Me.LblCurrency.Size = New System.Drawing.Size(60, 16)
        Me.LblCurrency.TabIndex = 3007
        ...
        Me.LinkLabel1.TabIndex = 3008
        Me.LinkLabel1.TabStop = True
        Me.LinkLabel1.Text = "Invoice For Following Items"
        ...
        Me.Label9.Location = New System.Drawing.Point(6, 426)
        Me.Label9.Name = "Label9"
        Me.Label9.Size = New System.Drawing.Size(134, 16)
        Me.Label9.TabIndex = 3010
        Me.Label9.Text = "Terms And Conditions"
        '
        ...
        Me.TxtTermsAndConditions.Location = New System.Drawing.Point(9, 445)
        ...
        Me.TxtTermsAndConditions.TabIndex = 3009
        '
        'FrmWorkOrderInvoice
        '
    ...
    Protected WithEvents RbtForWorkReceive As System.Windows.Forms.RadioButton
...
#End Region
    ...
    Private Sub FrmWorkInvoice_BaseEvent_ApproveDeletion_InTrans(ByVal SearchCode As String, ByVal Conn As SQLiteConnection, ByVal Cmd As SQLiteCommand) Handles Me.BaseEvent_ApproveDeletion_InTrans
    ...
    Private Sub FrmWorkInvoice_BaseEvent_Form_PreLoad() Handles Me.BaseEvent_Form_PreLoad
        MainTableName = "WorkInvoice"
        LogTableName = "WorkInvoice_Log"
        MainLineTableCsv = "WorkInvoiceDetail"
        LogLineTableCsv = "WorkInvoiceDetail_Log"
    ...
    Private Sub WorkInvoice_BaseFunction_FIniMast(ByVal BytDel As Byte, ByVal BytRefresh As Byte) Handles Me.BaseFunction_FIniMast
        Dim mCondStr$
    ...
    Private Sub FrmWorkInvoice_BaseEvent_FindMain() Handles Me.BaseEvent_FindMain
        Dim mCondStr$

        mCondStr = " " & AgL.CondStrFinancialYear("H.V_Date", AgL.PubStartDate, AgL.PubEndDate) &
                        " And " & AgL.PubSiteCondition("H.Site_Code", AgL.PubSiteCode) & " And H.Div_Code = '" & AgL.PubDivCode & "'"
        mCondStr = mCondStr & " And Vt.NCat In ('" & EntryNCat & "')"
        AgL.PubFindQry = " SELECT H.DocID AS SearchCode, Vt.Description AS [Invoice_Type], H.V_Date As [Invoice_Date] , " &
                            " H.ManualRefNo, H.PartyName, H.Currency, H.SalesTaxGroupParty " &
                            " FROM WorkInvoice H " &
                            " LEFT JOIN Voucher_Type Vt ON Vt.V_Type = H.V_Type " &
                            " Where 1=1  " & mCondStr
        AgL.PubFindQryOrdBy = "[Invoice_Date]"
    End Sub

    Private Sub FrmWorkInvoice_BaseFunction_IniGrid() Handles Me.BaseFunction_IniGrid
        Dgl1.ColumnCount = 0
        With AgCL
            ...
            .AddAgTextColumn(Dgl1, Col1WorkDispatch, 100, 0, Col1WorkDispatch, True, True)
            .AddAgTextColumn(Dgl1, Col1WorkDispatchSr, 40, 5, Col1WorkDispatchSr, False, True, False)
        ...
        AgL.ProcCreateLink(Dgl1, Col1WorkDispatch)
    ...
    Private Sub FrmWorkInvoice_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As SQLiteConnection, ByVal Cmd As SQLiteCommand) Handles Me.BaseEvent_Save_InTrans
        Dim I As Integer, mSr As Integer
        Dim bSelectionQry$ = "", bInvoiceType$ = "", bStockSelectionQry$ = ""

        mQry = " UPDATE WorkInvoice " &
                " SET ManualRefNo = " & AgL.Chk_Text(TxtReferenceNo.Text) & ", " &
        ...
        mSr = AgL.VNull(AgL.Dman_Execute("Select Max(Sr) From WorkInvoiceDetail  Where DocID = '" & mSearchCode & "'", AgL.GcnRead).ExecuteScalar)
            ...
            If Dgl1.Item(Col1Item, I).Value <> "" Then
                If Dgl1.Item(ColSNo, I).Tag Is Nothing And Dgl1.Rows(I).Visible = True Then
                    ...
                    bSelectionQry += " Select " & AgL.Chk_Text(mSearchCode) & ", " & mSr & ", " &
                                        ...
                                        " " & AgL.Chk_Text(Dgl1.Item(Col1WorkDispatch, I).Tag) & ", " &
                                        " " & AgL.Chk_Text(Dgl1.Item(Col1WorkDispatchSr, I).Value) & ", " &
                ...
                Else
                    If Dgl1.Rows(I).Visible = True Then
                        If Dgl1.Rows(I).DefaultCellStyle.BackColor <> AgTemplate.ClsMain.Colours.GridRow_Locked Then
                            mQry = " UPDATE WorkInvoiceDetail " &
                                    " SET " &
                                    " WorkOrder = " & AgL.Chk_Text(Dgl1.Item(Col1WorkOrder, I).Tag) & ", " &
                                    " WorkOrderSr = " & AgL.Chk_Text(Dgl1.Item(Col1WorkOrderSr, I).Value) & ", " &
                                    " WorkDispatch = " & AgL.Chk_Text(Dgl1.Item(Col1WorkDispatch, I).Tag) & ", " &
                                    " WorkDispatchSr = " & AgL.Chk_Text(Dgl1.Item(Col1WorkDispatchSr, I).Value) & ", " &
                        ...
                        End If
                    Else
                        mQry = " Delete From WorkInvoiceDetail Where DocId = '" & mSearchCode & "' And Sr = " & Val(Dgl1.Item(ColSNo, I).Tag) & "  "
                        AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)
                    End If
                End If
            End If
        ...
        If bSelectionQry <> "" Then
            mQry = " INSERT INTO WorkInvoiceDetail ( DocId, Sr, WorkOrder,WorkOrderSr, WorkDispatch,WorkDispatchSr, " &
                    ...
                    " Remark, WorkInvoice, WorkInvoiceSr, " &
    ...
    Private Sub FrmWorkInvoice_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        Dim I As Integer
        ...
        mQry = " Select H.*, Sg.Name + ',' + IfNull(C1.CityName,'') As PartyDesc, " &
               ...
               " From (Select * From WorkInvoice  Where DocID='" & SearchCode & "') H " &
        ...
        With DsTemp.Tables(0)
            If .Rows.Count > 0 Then
                ...
                '-------------------------------------------------------------
                mQry = "Select L.*, I.Description As ItemDesc, I.ManualCode, C.V_Type + '-' + C.ManualRefNo As WorkInvoiceNo, " &
                        " O.V_Type + '-' + O.ManualRefNo As OrderRefNo, D.V_Type + '-' + D.ManualRefNo As WorkDispatchNo, Iu.Item_Uid As Item_UidDesc, IG.Description AS ItemGroupDesc, " &
                        ...
                        " From (Select * From WorkInvoiceDetail  Where DocId = '" & SearchCode & "') As L " &
                        " LEFT JOIN Item I  ON L.Item = I.Code " &
                        " LEFT JOIN Item_Uid Iu ON L.Item_Uid = Iu.Code " &
                        " LEFT JOIN WorkInvoice C  On L.WorkInvoice = C.DocId " &
                        " LEFT JOIN Process P   On L.FromProcess = P.NCat " &
                        " Left Join ItemGroup IG On I.ItemGroup = IG.Code " &
                        " LEFT JOIN WorkDispatch D  On L.WorkDispatch = D.DocId " &
                ...
                With DsTemp.Tables(0)
                    ...
                    If .Rows.Count > 0 Then
                        For I = 0 To DsTemp.Tables(0).Rows.Count - 1
                            ...
                            Dgl1.Item(Col1WorkDispatch, I).Tag = AgL.XNull(.Rows(I)("WorkDispatch"))
                            Dgl1.Item(Col1WorkDispatch, I).Value = AgL.XNull(.Rows(I)("WorkDispatchNo"))
                            Dgl1.Item(Col1WorkDispatchSr, I).Value = AgL.VNull(.Rows(I)("WorkDispatchSr"))
    ...
    Private Sub FrmWorkInvoice_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            Select Case sender.NAME
                Case TxtV_Type.Name
                    ...
                    IniGrid()
                    TxtReferenceNo.Text = AgTemplate.ClsMain.FGetManualRefNo("ManualRefNo", "WorkInvoice", TxtV_Type.AgSelectedValue, TxtV_Date.Text, TxtDivision.AgSelectedValue, TxtSite_Code.AgSelectedValue, AgTemplate.ClsMain.ManualRefType.Max)
                    FAsignProcess()
                ...
                Case TxtReferenceNo.Name
                    e.Cancel = Not AgTemplate.ClsMain.FCheckDuplicateRefNo("ManualRefNo", "WorkInvoice",
    ...
    Private Sub FrmWorkInvoice_BaseEvent_Topctrl_tbAdd() Handles Me.BaseEvent_Topctrl_tbAdd
        If AgL.XNull(DtV_TypeSettings.Rows(0)("Structure")) = "" Then
            TxtStructure.AgSelectedValue = AgStructure.ClsMain.FGetStructureFromNCat(LblV_Type.Tag, AgL.GcnRead)
            AgCalcGrid1.AgStructure = TxtStructure.AgSelectedValue
        Else
        ...
        Try
            ...
            Else
                If Dgl1.AgDataRow IsNot Nothing Then
                    ...
                    Dgl1.Item(Col1WorkDispatch, mRow).Tag = AgL.XNull(Dgl1.AgDataRow.Cells("WorkDispatch").Value)
                    Dgl1.Item(Col1WorkDispatch, mRow).Value = AgL.XNull(Dgl1.AgDataRow.Cells("WorkDispatchNo").Value)
                    Dgl1.Item(Col1WorkDispatchSr, mRow).Value = AgL.XNull(Dgl1.AgDataRow.Cells("WorkDispatchSr").Value)
    ...
    Private Sub FrmWorkInvoice_BaseFunction_Calculation() Handles Me.BaseFunction_Calculation
        Dim I As Integer
        If Topctrl1.Mode = "Browse" Then Exit Sub
    ...
    Private Sub FrmWorkOrder_BaseEvent_Data_Validation(ByRef passed As Boolean) Handles Me.BaseEvent_Data_Validation
        ...
        passed = AgTemplate.ClsMain.FCheckDuplicateRefNo("ManualRefNo", "WorkInvoice", TxtV_Type.AgSelectedValue, TxtV_Date.Text, TxtDivision.AgSelectedValue,
                                    TxtSite_Code.AgSelectedValue, Topctrl1.Mode, TxtReferenceNo.Text, mSearchCode)
        ...
        If AgCL.AgIsDuplicate(Dgl1, "" + Dgl1.Columns(Col1Item).Index.ToString + "," + Dgl1.Columns(Col1Item_UID).Index.ToString + "," + Dgl1.Columns(Col1LotNo).Index.ToString + "," + Dgl1.Columns(Col1FromProcess).Index.ToString + "," + Dgl1.Columns(Col1WorkOrder).Index.ToString + "," + Dgl1.Columns(Col1WorkDispatch).Index.ToString + "," + Dgl1.Columns(Col1WorkDispatchSr).Index.ToString + "," + Dgl1.Columns(Col1Dimension1).Index.ToString + "," + Dgl1.Columns(Col1Dimension2).Index.ToString + "") Then passed = False : Exit Sub
    ...
    Private Sub FCreateHelpItem()
        ...
        If RbtForWorkOrder.Checked Then
            mQry = FRetFillItemFromOrderQry("", strCond)
            Dgl1.AgHelpDataSet(Col1Item, 18) = AgL.FillData(mQry, AgL.GCn)
        Else
            mQry = FRetFillItemFromReceiveQry("", strCond)
            Dgl1.AgHelpDataSet(Col1Item, 16) = AgL.FillData(mQry, AgL.GcnRead)
        End If
    End Sub
    ...
    Private Sub FrmSpinningPayment_BaseEvent_Topctrl_tbPrn(ByVal SearchCode As String) Handles Me.BaseEvent_Topctrl_tbPrn
        mQry = " SELECT H.DocID, H.V_Type, H.V_Prefix,H.V_Date, H.V_No, H.ManualRefNo, H.EntryBy, H.SalesTaxGroupParty, " &
                " H.PartyName, H.PartyAdd1, H.PartyAdd2, C.CityName AS PartyCity, H.PartyMobile , H.BillToParty, H.TermsAndConditions, " &
                " SG.DispName AS BillToPartyName, H.Currency, H.Remarks , L.Sr, L.V_Nature, WO.V_Type + '-' + WO.ManualRefNo AS DispatchNo, " &
                " L.WorkDispatchSr, L.Specification, L.LotNo, L.DocQty, L.LossQty, L.Qty, L.Unit, L.MeasurePerPcs, L.BaleNo, " &
                " L.Rate, L.Amount, L.Remark AS LineRemark , G.Description AS GodownDesc , U.DecimalPlaces, I.Description AS ItemDesc, I.ItemType, " &
                ...
                " LEFT JOIN WorkInvoiceDetail L   ON L.DocId = H.DocID  " &
                " LEFT JOIN WorkDispatch WO  ON WO.DocID = L.WorkDispatch  " &
                " LEFT JOIN Godown G  ON G.Code = H.Godown  " &
        ...
        ClsMain.FPrintThisDocument(Me, TxtV_Type.Tag, mQry, "Work_WorkInvoice_Print", "Job Work Invoice")
    End Sub
    ...
    Private Function FHPGD_PendingWorkOrder() As String
        ...
        If RbtForWorkOrder.Checked Then
            mQry = " SELECT 'o' As Tick, VMain.WorkOrder , " &
                    ...
                    " FROM ( " & FRetFillItemFromOrderQry(strCond, "") & " ) As VMain " &
        ...
        Else
            mQry = " SELECT 'o' As Tick, VMain.WorkDispatch, Max(VMain.WorkDispatchNo) AS WorkDispatchNo, " &
                    " Max(VMain.WorkDispatchDate) AS WorkDispatchDate, IfNull(Sum(VMain.Qty), 0) As [Qty]    " &
                    " FROM ( " & FRetFillItemFromReceiveQry(strCond, "") & " ) As VMain " &
                    " GROUP BY VMain.WorkDispatch " &
                    " Order By WorkDispatchDate "
            FRH_Multiple = New DMHelpGrid.FrmHelpGrid_Multi(New DataView(AgL.FillData(mQry, AgL.GCn).TABLES(0)), "", 500, 400, , , False)
            FRH_Multiple.FFormatColumn(0, "Tick", 40, DataGridViewContentAlignment.MiddleCenter, True)
            FRH_Multiple.FFormatColumn(1, , 0, , False)
            FRH_Multiple.FFormatColumn(2, "Dispatch No.", 100, DataGridViewContentAlignment.MiddleLeft)
            FRH_Multiple.FFormatColumn(3, "Dispatch Date", 100, DataGridViewContentAlignment.MiddleLeft)
            FRH_Multiple.FFormatColumn(4, "Balance", 70, DataGridViewContentAlignment.MiddleRight)
        End If
    ...
    Private Function FRetFillItemFromOrderQry(ByVal HeaderConStr As String, ByVal LineConStr As String) As String
        FRetFillItemFromOrderQry = "SELECT Max(L.Item) As Code, Max(I.Description) AS ItemDesc, Max(H.V_Type) + '-' +  Max(H.ManualRefNo) AS WorkOrderNo, Max(H.V_Date) As WorkOrderDate, Max(IG.Description) AS ItemGroupDesc, " &
                  ...
                  " Max(L.Specification) As Specification, IfNull(Sum(L.Qty),0) - IfNull(Max(Cd.DispatchQty), 0) As Qty, Max(L.Unit) As Unit, " &
                  " Max(I.ManualCode) AS ItemCode, L.WorkOrder, L.WorkOrderSr, Max(L.Rate) AS Rate, Max(L.LotNo) AS LotNo, NUll AS WorkDispatch, NUll AS WorkDispatchNo, NUll AS WorkDispatchSr, " &
                  " IfNull(Sum(L.TotalDeliveryMeasure),0) - IfNull(Max(Cd.DispatchDeliveryMeasure), 0) As TotalDeliveryMeasure, NULL AS Item_UidDesc, NULL AS Item_Uid, " &
                  " Max(L.MeasurePerPcs) As MeasurePerPcs, Max(L.MeasureUnit) As MeasureUnit, Max(L.DeliveryMeasure) As DeliveryMeasure, " &
    ...
    Private Function FRetFillItemFromReceiveQry(ByVal HeaderConStr As String, ByVal LineConStr As String) As String
        FRetFillItemFromReceiveQry = "SELECT Max(L.Item) As Code, Max(I.Description) as ItemDesc,  Max(H.V_Type) + '-' +  Max(H.ManualRefNo) AS WorkDispatchNo,    Max(H.V_Date) as WorkDispatchDate, " &
                " Max(D1.Description) As " & AgTemplate.ClsMain.FGetDimension1Caption() & ", " &
                " Max(D2.Description) As " & AgTemplate.ClsMain.FGetDimension2Caption() & ", " &
                " Sum(L.Qty) - IfNull(Max(Cd.Qty), 0) As Qty,    Max(I.Unit) as Unit, Max(I.ManualCode) As ItemCode, Max(L.LotNo) AS LotNo,  Max(I.MeasureUnit) MeasureUnit, Max(L.Rate) as Rate, Max(L.Specification) as Specification," &
                " IfNull(Sum(L.TotalDeliveryMeasure), 0) As TotalDeliveryMeasure, Max(L.MeasurePerPcs) as MeasurePerPcs, Max(IG.Description) AS ItemGroupDesc,  Max(L.WorkOrder) As WorkOrder, Max(Jo.V_Type) + '-' +  Max(Jo.ManualRefNo) As WorkOrderNo, Max(L.WorkOrderSr) As WorkOrderSr, Max(U.DecimalPlaces) as QtyDecimalPlaces,  " &
                " Max(L.Dimension1) As Dimension1, Max(L.Dimension2) As Dimension2,  " &
                " Max(U1.DecimalPlaces) as MeasureDecimalPlaces, Max(L.Item_Uid) As Item_Uid, Max(Iu.Item_Uid) As Item_UidDesc, Max(L.DeliveryMeasure) As DeliveryMeasure, L.WorkDispatch As WorkDispatch, L.WorkDispatchSr As WorkDispatchSr " &
                " FROM ( " &
                "       SELECT DocID, V_Type, ManualRefNo, V_Date  " &
                "       FROM WorkDispatch  Where 1=1  " & HeaderConStr & " ) H   " &
                " LEFT JOIN WorkDispatchDetail L  ON H.DocID = L.WorkDispatch  " &
                " LEFT JOIN WorkOrder Jo  ON L.WorkOrder = Jo.DocId  " &
                " Left Join Item I  On L.Item  = I.Code  " &
                " LEFT JOIN ItemGroup IG On Ig.Code = I.ItemGroup  " &
                " LEFT JOIN Item_Uid Iu On L.Item_Uid = Iu.Code  " &
                " LEFT JOIN Voucher_Type Vt  ON H.V_Type = Vt.V_Type  " &
                " Left Join ( " &
                "       SELECT L.WorkDispatch , L.WorkDispatchSr, Sum(L.Qty) AS Qty " &
                "       FROM WorkInvoiceDetail L    " &
                "       LEFT JOIN WorkInvoice  H  ON L.DocId = H.DocID  " &
                "       WHERE L.DocId <> '" & mSearchCode & "' " &
                "       And H.Party = '" & TxtParty.Tag & "' " &
                "       GROUP BY L.WorkDispatch , L.WorkDispatchSr	 " &
                " ) AS CD ON L.DocId = CD.WorkDispatch AND L.Sr = CD.WorkDispatchSr  " &
                " LEFT JOIN Unit U On L.Unit = U.Code  " &
                " LEFT JOIN Unit U1 On L.MeasureUnit = U1.Code " &
                " Left Join Dimension1 D1   On L.Dimension1 = D1.Code " &
                " Left Join Dimension2 D2   On L.Dimension2 = D2.Code " &
                " WHERE 1 = 1  GROUP BY L.WorkDispatch, L.WorkDispatchSr   " &
                " HAVING IfNull(Sum(L.Qty),0) - IfNull(Max(Cd.Qty), 0) > 0 "
    End Function

    Private Sub FProcFillItems(ByVal bOrderNoStr As String)
        Dim I As Integer = 0
        Dim DtTemp As DataTable = Nothing
        Try
            ...
            If RbtForWorkOrder.Checked Then
                mQry = FRetFillItemFromOrderQry(" And DocId In (" & bOrderNoStr & ") ", "")
                DtTemp = AgL.FillData(mQry, AgL.GCn).Tables(0)
            Else
                mQry = FRetFillItemFromReceiveQry(" And DocId In (" & bOrderNoStr & ") ", "")
                DtTemp = AgL.FillData(mQry, AgL.GCn).Tables(0)
            End If
            ...
            With DtTemp
                ...
                If .Rows.Count > 0 Then
                    For I = 0 To .Rows.Count - 1
                        ...
                        Dgl1.Item(Col1WorkDispatch, I).Tag = AgL.XNull(.Rows(I)("WorkDispatch"))
                        Dgl1.Item(Col1WorkDispatch, I).Value = AgL.XNull(.Rows(I)("WorkDispatchNo"))
                        Dgl1.Item(Col1WorkDispatchSr, I).Value = AgL.XNull(.Rows(I)("WorkDispatchSr"))
                        ...
                        If AgL.XNull(.Rows(I)("DeliveryMeasure")) = "" Then
                            Dgl1.Item(Col1DeliveryMeasure, I).Value = AgL.XNull(.Rows(I)("Unit"))
                            Dgl1.Item(Col1DeliveryMeasure, I).Tag = AgL.XNull(.Rows(I)("Unit"))
                            Dgl1.Item(Col1DeliveryMeasureMultiplier, I).Value = 1
                            Dgl1.Item(Col1DeliveryMeasureDecimalPlaces, I).Value = AgL.VNull(.Rows(I)("QtyDecimalPlaces"))
                        Else
                            Dgl1.Item(Col1DeliveryMeasure, I).Value = AgL.XNull(.Rows(I)("DeliveryMeasure"))
    ...
    Private Sub RbtForWorkOrder_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles RbtForWorkOrder.Click, RbtForWorkReceive.Click
