Public Class FrmWorkOrderBom
    ...
    Sub KeyPress_Form(ByVal Sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        If e.KeyChar = Chr(Keys.Escape) Then
            If AgL.StrCmp(CType(Me.Owner, FrmWorkOrder).Topctrl1.Mode, "Browse") Then Me.Close() : Exit Sub
            Me.Close()
        End If
    End Sub
    ...
    Private Sub Form_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            AgL.GridDesign(Dgl1)
            Calculation()
            If AgL.StrCmp(CType(Me.Owner, FrmWorkOrder).Topctrl1.Mode, "Browse") Then
                Dgl1.ReadOnly = True
            Else
                Dgl1.ReadOnly = False
            End If
    ...
    Private Sub Dgl1_EditingControl_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Dgl1.EditingControl_KeyDown
        Try
            If AgL.StrCmp(CType(Me.Owner, FrmWorkOrder).Topctrl1.Mode, "Browse") Then Exit Sub
