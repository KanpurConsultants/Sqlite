...
#End Region
    ...
    Private Sub FrmSaleOrder_BaseFunction_IniGrid() Handles Me.BaseFunction_IniGrid
        ...
        With AgCL
            ...
            .AddAgTextColumn(Dgl1, Col1SaleChallan, 150, 255, Col1SaleChallan, IsApplicable_Challan, True)
    ...
    Private Sub FrmSaleOrder_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As SqliteConnection, ByVal Cmd As SqliteCommand) Handles Me.BaseEvent_Save_InTrans
        ...
        'mQry = " UPDATE SaleInvoice Set SaleInvoice.SaleToPartyTinNo = SubGroup.TINNo, " & _
        '        " SaleInvoice.SaleToPartyCstNo = SubGroup.CSTNo , SaleInvoice.SaleToPartyLstNo  = SubGroup.LSTNo " & _
        '        " From SubGroup " & _
        ...
        For I = 0 To Dgl1.RowCount - 1
            If Dgl1.Item(Col1Item, I).Value <> "" Then
                ...
                bSelectionQry += " Select " & AgL.Chk_Text(mSearchCode) & ", " & mSr & ", " & _
                                    ...
                                    " " & AgL.Chk_Text(mSearchCode) & ", " & Val(mSr) & ", " & _
                                    " " & AgCalcGrid1.FLineTableFieldValuesStr(I) & " "
            End If
        Next


        mQry = "Insert Into SaleInvoiceDetail(DocId, Sr, TransactionType, SaleOrder, SaleOrderSr, Item_Uid, Item, ItemInvoiced, Specification, SalesTaxGroupItem, " & _
    ...
    Private Sub FrmSaleOrder_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        mQry = "Select H.*, 
                H.Remarks, H.TotalQty, Sg.Name || ',' || IfNull(C1.CityName,'') As SaleToPartyDesc, BillToParty.Name || ',' || IfNull(BillToPartyCity.CityName,'') As BillToPartyDesc, 
