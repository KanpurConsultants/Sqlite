Public Class FrmImportSaleOrderFromExcel
    Public WithEvents Dgl1 As New AgControls.AgDataGrid

    Dim mUserAction As String = "None"
    Dim DsExcelData As New DataSet
    Dim DsExcelLinedata As New DataSet
    ...
    Public ReadOnly Property P_DsExcelLinedata() As DataSet
        Get
            Return DsExcelLinedata
        End Get
    End Property
    ...
    Private Sub BtnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnOK.Click, BtnCancel.Click
        ...
        Select Case sender.name
            Case BtnOK.Name
                MyCommand = New System.Data.OleDb.OleDbDataAdapter("select Max(SaleToPartyName) As SaleToPartyName, Max(SaleOrderDate) As SaleOrderDate, Max(PartyOrderDate) As PartyOrderDate, Max(PartyDeliveryDate) As PartyDeliveryDate, PartyOrderNo  from [sheet1$] Group BY  PartyOrderNo  ", MyConnection)
                MyCommand.Fill(DsExcelData)

                MyCommand = New System.Data.OleDb.OleDbDataAdapter("select *  from [sheet1$] ", MyConnection)
                MyCommand.Fill(DsExcelLinedata)
