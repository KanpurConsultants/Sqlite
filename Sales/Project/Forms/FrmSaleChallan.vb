...
#Region "Form Designer Code"
    Private Sub InitializeComponent()
        ...
        Me.LblPaidAmt.Size = New System.Drawing.Size(62, 16)
        ...
        Me.LblHelp.Location = New System.Drawing.Point(240, 140)
...
#End Region
    ...
    Private Sub FrmSaleChallan_BaseEvent_ApproveDeletion_InTrans(ByVal SearchCode As String, ByVal Conn As SqliteConnection, ByVal Cmd As SqliteCommand) Handles Me.BaseEvent_ApproveDeletion_InTrans
        ...
        mQry = " Delete From SaleInvoiceDetail Where DocId = '" & mSearchCode & "'"
        AgL.Dman_ExecuteNonQry(mQry, AgL.GCn, AgL.ECmd)

        mQry = " Delete From SaleInvoice Where DocId = '" & mSearchCode & "'"
        AgL.Dman_ExecuteNonQry(mQry, AgL.GCn, AgL.ECmd)
    End Sub
    ...
    Private Sub FrmSaleOrder_BaseFunction_IniGrid() Handles Me.BaseFunction_IniGrid
        ...
        With AgCL
            ...
            .AddAgTextColumn(Dgl1, Col1SaleChallan, 150, 255, Col1SaleChallan, True, True)
    ...
    Private Sub FrmSaleOrder_BaseEvent_Save_InTrans(ByVal SearchCode As String, ByVal Conn As SQLiteConnection, ByVal Cmd As SQLiteCommand) Handles Me.BaseEvent_Save_InTrans
        ...
        Dim bLanded_Value As Double
        Dim bLanded_Rate As Double
        ...
        For I = 0 To Dgl1.RowCount - 1
            If Dgl1.Item(Col1Item, I).Value <> "" Then
                ...
                bLanded_Value = Val(AgCalcGrid1.AgChargesValue(AgTemplate.ClsMain.Charges.PENALTY, I, AgStructure.AgCalcGrid.LineColumnType.Amount))
                bLanded_Rate = bLanded_Value / (bQty_Iss + bQty_Rec)

                If bStockSelectionQry <> "" Then bStockSelectionQry += " UNION ALL "
                bStockSelectionQry += " Select '" & mInternalCode & "',  " & Val(mSr) & ", " &
                        " " & AgL.Chk_Text(TxtV_Type.Tag) & ", " &
                        " " & AgL.Chk_Text(LblPrefix.Text) & ", " & AgL.Chk_Text(TxtV_Date.Text) & ", " &
                        " " & Val(TxtV_No.Text) & ", " & AgL.Chk_Text(TxtReferenceNo.Text) & ", " & AgL.Chk_Text(TxtDivision.Tag) & ", " &
                        " " & AgL.Chk_Text(TxtSite_Code.Tag) & ", " &
                        " " & AgL.Chk_Text(TxtSaleToParty.Tag) & ", " &
                        " " & AgL.Chk_Text(TxtCurrency.Tag) & ", " &
                        " " & AgL.Chk_Text(TxtSalesTaxGroupParty.Tag) & ", " &
                        " " & AgL.Chk_Text(TxtStructure.Tag) & ", " &
                        " " & AgL.Chk_Text(Dgl1.Item(Col1BillingType, I).Value) & ", " &
                        " " & AgL.Chk_Text(Dgl1.Item(Col1Item, I).Tag) & ", " &
                        " " & AgL.Chk_Text(Dgl1.Item(Col1Item_UID, I).Value) & ", " &
                        " " & AgL.Chk_Text(Dgl1.Item(Col1LotNo, I).Value) & ", " &
                        " " & AgL.Chk_Text(TxtGodown.Tag) & ", " &
                        " 'I', " &
                        " " & bQty_Iss & ", " &
                        " " & bQty_Rec & ", " &
                        " " & AgL.Chk_Text(Dgl1.Item(Col1Unit, I).Value) & ", " &
        ...
        mQry = "Insert Into SaleChallanDetail(DocId, Sr, TransactionType, SaleOrder, SaleOrderSr, Item_Uid, Item, Specification, SalesTaxGroupItem, " &
               " FreeQty, Qty, Unit, MeasurePerPcs, MeasureUnit, " &
               " TotalFreeMeasure, TotalMeasure, Rate, RatePerQty, RatePerMeasure, Amount, MRP, ExpiryDate, Remark, " &
               " BillingType, RateType, BaleNo, LotNo, DeliveryMeasure, " &
               " DeliveryMeasureMultiplier, TotalDeliveryMeasure, ReferenceDocId, ReferenceDocIdSr, " &
               " SaleChallan, SaleChallanSr, " & AgCalcGrid1.FLineTableFieldNameStr() & ") " & bSelectionQry
        AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)

        mQry = "Insert Into Stock(DocID, Sr, V_Type, V_Prefix, V_Date, V_No, RecID, Div_Code, Site_Code, " &
                  " SubCode, Currency, SalesTaxGroupParty, Structure, BillingType, Item, Item_Uid, LotNo, " &
                  " Godown, EType_IR, Qty_Iss, Qty_Rec, Unit, MeasurePerPcs, Measure_Iss, MeasureUnit, " &
                  " Rate, Amount, Landed_Value, ReferenceDocID, ReferenceDocIDSr) " & bStockSelectionQry
        AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)


        If CType(AgL.VNull(DtV_TypeSettings.Rows(0)("IsPostInSaleInvoice")), Boolean) = True Then
    ...
    Private Sub FrmSaleOrder_BaseFunction_MoveRec(ByVal SearchCode As String) Handles Me.BaseFunction_MoveRec
        ...
        mQry = " Select H.*, Sg.Name || ',' || IfNull(C1.CityName,'') As SaleToPartyDesc, " &
               ...
               " From (Select * From SaleChallan  Where DocID='" & SearchCode & "') H " &
        ...
        With DsTemp.Tables(0)
            If .Rows.Count > 0 Then
                ...
                mQry = "Select L.*, I.Description As ItemDesc, I.ManualCode, C.V_Type || '-' || C.ReferenceNo As ChallanRefNo, " &
                        ...
                        " Pc.V_Type || '-' || Pc.ReferenceNo As PurchaseNo, " &
                        ...
                        " Pcl.Landed_Value/Pcl.Qty as PurchaseRate, Pid.DocId As PurchIndent, Sc.V_Type || '-' ||  Sc.ReferenceNo As SaleChallanNo " &
                        " From (Select * From SaleChallanDetail  Where DocId = '" & SearchCode & "') As L " &
                        ...
                        " LEFT JOIN SaleChallan Sc On L.SaleChallan = Sc.DocId " &
        ...
        Try
            Select Case sender.NAME
                ...
                Case TxtReferenceNo.Name
                    e.Cancel = Not AgTemplate.ClsMain.FCheckDuplicateRefNo("ReferenceNo", "SaleChallan",
        ...
        Try
            ...
            Select Case Dgl1.Columns(Dgl1.CurrentCell.ColumnIndex).Name
                ...
                Case Col1Item
                    ...
                    FShowLastRates(Dgl1.Item(Col1Item, mRowIndex).Tag)
                Case Col1ItemCode
                    Validating_ItemCode(mColumnIndex, mRowIndex)
                    Call FGetDeliveryMeasureMultiplier(mRowIndex)
                ...
                If .Item(Col1Item, I).Value <> "" Then
                    ...
                    If AgL.StrCmp(Dgl1.Item(Col1TransactionType, I).Value, ChallanType_Return) Then
                        mQry = " Select IfNull(Sum(Qty), 0)  " &
                                ...
                                " AND L.SaleChallan = '" & Dgl1.Item(Col1SaleChallan, I).Tag & "' " &
                                " AND L.SaleChallanSr = " & Val(Dgl1.Item(Col1SaleChallanSr, I).Value) & "" &
                                " And DocId <> '" & mSearchCode & "'"
                        If AgL.VNull(AgL.Dman_Execute(mQry, AgL.GCn).ExecuteScalar) < Val(Dgl1.Item(Col1Qty, I).Value) Then
            ...
            Select Case sender.name
                ...
                Case TxtBillToParty.Name
                    If CType(sender, AgControls.AgTextBox).AgHelpDataSet Is Nothing Then
                        If e.KeyCode <> Keys.Enter Then
                            FCreateHelpSubgroup()
                            TxtBillToParty.AgHelpDataSet(8) = TxtSaleToParty.AgHelpDataSet
                        End If
                    End If
    ...
    Private Function FCheckDuplicateRefNo() As Boolean
        ...
        If Topctrl1.Mode = "Add" Then
            mQry = " SELECT COUNT(*) FROM SaleChallan WHERE ReferenceNo = '" & TxtReferenceNo.Text & "'   " &
    ...
    Private Sub PrintDocument(ByVal SearchCode As String)
        ...
        Try
            ...
            mQry = " SELECT H.DocID, H.V_Type, H.V_Prefix, H.V_Date, H.V_No, H.Div_Code, H.Site_Code, H.ReferenceNo, H.SaleToParty, " &
                        ...
                        " FROM (SELECT * FROM SaleChallan  WHERE DocId = '" & mSearchCode & "') As H  " &
                        " LEFT JOIN (SELECT * FROM SaleChallanDetail   WHERE DocId = '" & mSearchCode & "') AS  L  ON H.DocID = L.DocId " &
                        " LEFT JOIN SubGroup Sg   ON H.SaleToParty = Sg.SubCode  " &
                        " LEFT JOIN City C   ON Sg.CityCode = C.CityCode " &
            ...
            AgL.ADMain = New SQLiteDataAdapter(mQry, AgL.GcnRead)
    ...
    Private Sub FSavePartyDetail(ByVal TableName As String, ByVal SearchCode As String, ByVal Conn As SQLiteConnection, ByVal Cmd As SQLiteCommand)
        If BtnFillPartyDetail.Tag Is Nothing Then Exit Sub

        mQry = " UPDATE " & TableName & " " &
    ...
    Private Sub FGetBaleStr(ByVal SearchCode As String)
        ...
        mQry = "Select Distinct Convert(INT,BaleNo) as BaleNo From SaleChallanDetail  Where DocId = '" & SearchCode & "' And IsNumeric(BaleNo) = 1 Order By  Convert(INT,BaleNo) "
        ...
        mQry = "Select Distinct BaleNo From SaleChallanDetail  Where DocId = '" & SearchCode & "' And IsNumeric(BaleNo) = 0 "
        DsTemp = AgL.FillData(mQry, AgL.GcnRead)
        With DsTemp.Tables(0)
            If .Rows.Count > 0 Then
                For I = 0 To DsTemp.Tables(0).Rows.Count - 1
    ...
    Private Sub Dgl1_EditingControl_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Dgl1.EditingControl_KeyDown
        Try
            Select Case Dgl1.Columns(Dgl1.CurrentCell.ColumnIndex).Name
                Case Col1Item
                    If e.KeyCode = Keys.Insert Then Call FOpenSaleChallan()
    ...
    Private Sub FPostInSaleInvoice(ByVal Conn As SQLiteConnection, ByVal Cmd As SQLiteCommand)
        ...
        mQry = "INSERT INTO SaleInvoice(DocId, Div_Code, Site_Code, V_Date, V_Type, V_Prefix, V_No, " &
                " ReferenceNo , " &
                " SaleToParty , " &
                " BillToParty , " &
                " Agent, " &
                ...
                " TotalAmount , " &
                " TotalMeasure , " &
                " TotalDeliveryMeasure , " &
                " TINNo , " &
                " CSTNo , " &
                " LSTNo , " &
                " EntryBy, EntryDate,  EntryType, EntryStatus, Status, " & AgCalcGrid1.FFooterTableFieldNameStr() & ") " &
                " Select H.DocId, H.Div_Code, H.Site_Code, H.V_Date, H.V_Type, H.V_Prefix, H.V_No, " &
                " H.ReferenceNo , " &
                " H.SaleToParty , " &
                " H.BillToParty , " &
                " H.Agent, " &
                " H.Currency , " &
                " H.SalesTaxGroupParty , " &
                " H.Structure , " &
                " H.Remarks , " &
                " H.CreditDays , " &
                " H.CreditLimit , " &
                ...
                " H.TotalAmount , " &
                " H.TotalMeasure , " &
                " H.TotalDeliveryMeasure , " &
                " Sg.TINNo , " &
                " Sg.CSTNo , " &
                " Sg.LSTNo , " &
                " H.EntryBy, H.EntryDate,  H.EntryType, H.EntryStatus, H.Status , " & AgCalcGrid1.FFooterTableFieldNameStr("H.", "H_") & " " &
                " From SaleChallan H " &
                " LEFT JOIN SubGroup Sg On H.SaleToParty = Sg.SubCode " &
                " WHere H.DocId = '" & mSearchCode & "'"
        AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)

        mQry = " INSERT INTO SaleInvoiceDetail(DocId, Sr, SaleOrder, Item, Specification, " &
                " SalesTaxGroupItem, DocQty, RejQty, Qty, Unit, MeasurePerPcs, MeasureUnit,  " &
                " TotalDocMeasure, TotalRejMeasure, TotalMeasure, BaleNo,  " &
                " Rate, Amount, Remark,  " &
                " UID, LotNo, SaleOrderSr, RateType, SaleChallan, SaleChallanSr, SaleInvoice, SaleInvoiceSr, " &
                " Item_UID, FreeQty, RatePerQty, RatePerMeasure, MRP, ExpiryDate,  " &
                " BillingType, Supplier, DeliveryMeasure, DeliveryMeasureMultiplier, TotalDeliveryMeasure,  " &
                " TotalFreeMeasure, ReferenceDocId, ReferenceDocIdSr, " & AgCalcGrid1.FLineTableFieldNameStr() & ") " &
                " SELECT DocId, Sr, L.SaleOrder, L.Item, L.Specification, " &
                " L.SalesTaxGroupItem, L.DocQty, L.RejQty, L.Qty, L.Unit, L.MeasurePerPcs, L.MeasureUnit,  " &
                " L.TotalDocMeasure, L.TotalRejMeasure, L.TotalMeasure, L.BaleNo,  " &
                " L.Rate, L.Amount, L.Remark,  " &
                " L.UID, L.LotNo, L.SaleOrderSr, L.RateType, L.SaleChallan, L.SaleChallanSr, DocId, Sr, " &
                " L.Item_UID, L.FreeQty, L.RatePerQty, L.RatePerMeasure, L.MRP, L.ExpiryDate,  " &
                " L.BillingType, L.Supplier, L.DeliveryMeasure, L.DeliveryMeasureMultiplier, L.TotalDeliveryMeasure,  " &
                " L.TotalFreeMeasure, L.ReferenceDocId, L.ReferenceDocIdSr, " & AgCalcGrid1.FLineTableFieldNameStr() &
                " FROM SaleChallanDetail L    " &
        ...
        mQry = AgStructure.ClsMain.FUpdateFooterDataFromLineDataStr(TxtStructure.Tag, mSearchCode, "SaleInvoice", "DocId", "SaleInvoiceDetail", "DocId")
        AgL.Dman_ExecuteNonQry(mQry, Conn, Cmd)
    End Sub
    ...
    'Private Sub FrmSaleChallan_BaseEvent_Save_PostTrans(ByVal SearchCode As String) Handles Me.BaseEvent_Save_PostTrans
    ...
    Private Sub FrmSpinningPayment_BaseEvent_Topctrl_tbPrn(ByVal SearchCode As String) Handles Me.BaseEvent_Topctrl_tbPrn
        ...
        Try
            ...
            AgL.PubReportTitle = "Sale Challan"
            RepName = "SaleInvoice_Print" : RepTitle = "Sale Challan"

            mQry = "SELECT H.DocID, H.V_Type, H.V_Prefix, H.V_Date, H.V_No, H.Div_Code, H.Site_Code, H.ReferenceNo, " &
                    "H.Godown, H.Vendor, H.SaleToParty, Sg.DispName As SaleToPartyName, H.SaleToPartyAddress, H.SaleToPartyCity, C.CityName As SaleToPartyCityName, " &
                    "H.SaleToPartyMobile, H.ShipToParty, H.ShipToPartyName, " &
                    "H.ShipToPartyAddress, H.ShipToPartyCity, H.ShipToPartyMobile, H.SaleOrder, " &
                    ...
                    "H.ShipmentThrough, H.CreditDays, H.Remarks, " &
                    ...
                    "H.MoveToLogDate, H.IsDeleted, H.Status, H.UID, " &
                    "H.BillToParty, H.SaleToPartyAdd1, H.SaleToPartyAdd2, H.CustomFields, " &
                    ...
                    "L.LotNo, L.UID, L.BaleNo, L.Remark, " &
                    "L.BillingType, L.Item_UID, L.DeliveryMeasure, L.DeliveryMeasureMultiplier, " &
                    "L.TotalDeliveryMeasure, L.RateType, " &
                    "I.Description AS ItemDesc, I.ManualCode As ItemManualCode, L.ExpiryDate, " &
                    "G.Description AS GodownDesc, Sg.DispName As PartyName, " &
                    "Sg.ManualCode As PartyManualCode, Sg.Add1, Sg.Add2, Sg.Add3, C.CityName, L.MRP, " &
                    " " & AgCalcGrid1.FFooterTableFieldNameStr("H.", "H_") & ", " &
                    " " & AgCalcGrid1.FLineTableFieldNameStr("L.", "L_") & " " &
                    " " & AgCustomGrid1.FHeaderTableFieldNameStr("H.", "H_") & " " &
                    "FROM SaleChallan H   " &
                    "LEFT JOIN SaleChallanDetail L   ON H.DocID = L.DocId " &
                    "LEFT JOIN Godown G   ON H.Godown = G.Code " &
                    "LEFT JOIN Item I   ON L.Item = I.Code " &
                    "LEFT JOIN SubGroup Sg   ON H.SaleToParty = Sg.SubCode " &
                    "LEFT JOIN City C   ON Sg.CityCode = C.CityCode " &
            ...
            mBalanceQry = " SELECT V1.SubCode, Sum(V1.CurrBillAmt) AS CurrBillAmt, Sum(V1.OtherTodaysBill) AS OtherTodaysBill, " &
                        " Sum(V1.OldBalance) AS OldBalance, Sum(V1.TodaysBalance) AS TodaysPayment, " &
                        " Sum(V1.OldBalance) + Sum(V1.OtherTodaysBill) + Sum(V1.CurrBillAmt)-Sum(V1.TodaysBalance) As NetBalance " &
                        " FROM ( " &
                        " SELECT L.SubCode, IfNull(Sum(L.AmtDr),0) AS CurrBillAmt, 0 AS OtherTodaysBill,0 AS OldBalance, 0 AS TodaysBalance  " &
                        " FROM Ledger L WHERE L.DocId = '" & mSearchCode & "' AND L.SubCode = '" & TxtBillToParty.Tag & "' GROUP BY L.SubCode " &
                        " UNION ALL  " &
                        " SELECT L.SubCode, 0 AS CurrBillAmt, IfNull(Sum(L.AmtDr),0) AS OtherTodaysBill,0 AS OldBalance, 0 AS TodaysBalance  " &
                        " FROM Ledger L WHERE L.V_Date = '" & TxtV_Date.Text & "' And L.DocId <> '" & mSearchCode & "' AND L.SubCode = '" & TxtBillToParty.Tag & "'  GROUP BY L.SubCode " &
                        " UNION ALL  " &
                        " SELECT L.SubCode, 0 AS CurrBillAmt, 0 AS OtherTodaysBill,IfNull(Sum(L.AmtDr),0) - IfNull(Sum(L.AmtCr),0)  AS OldBalance, 0 AS TodaysBalance  " &
                        " FROM Ledger L WHERE L.V_Date < '" & TxtV_Date.Text & "' AND L.SubCode = '" & TxtBillToParty.Tag & "' GROUP BY L.SubCode " &
                        " UNION ALL  " &
                        " SELECT L.SubCode, 0 AS CurrBillAmt, 0 AS OtherTodaysBill,0 AS OldBalance, IfNull(Sum(L.AmtCr),0) AS TodaysBalance  " &
                        " FROM Ledger L WHERE  L.V_Date = '" & TxtV_Date.Text & "' AND L.SubCode = '" & TxtBillToParty.Tag & "' GROUP BY L.SubCode " &
                        " ) AS V1  " &
                        " GROUP BY V1.SubCode "

            AgL.ADMain = New SQLiteDataAdapter(mBalanceQry, AgL.GCn)
    ...
    Private Sub FrmSaleChallan_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub FShowLastRates(ByVal Item As String)
        Dim DtTemp As DataTable = Nothing
        Try
            mQry = " SELECT H.V_Date AS [Sale_Date], L.Item, " &
    ...
    Private Sub FCreateHelpItem()
        ...
        If AgL.StrCmp(Dgl1.Item(Col1TransactionType, Dgl1.CurrentCell.RowIndex).Value, ChallanType_Return) Then
            mQry = " SELECT Max(L.Item) As Code, " &
                    ...
                    " Max(L.MeasurePerPcs) as MeasurePerPcs, L.SaleChallanSr, L.SaleChallan,     " &
                    " Max(U.DecimalPlaces) as QtyDecimalPlaces,    " &
                    " Max(L.BillingType) As BillingType,    " &
                    " Max(U1.DecimalPlaces) as MeasureDecimalPlaces,   " &
        ...
        ElseIf AgL.StrCmp(Dgl1.Item(Col1TransactionType, Dgl1.CurrentCell.RowIndex).Value, ChallanType_DirectReturn) Then
            mQry = "SELECT I.Code, I.Description, I.ManualCode, '' As SaleChallanNo, " &
                  ...
                  " '' As SaleChallan, '' As SaleChallanNo, 0 As SaleChallanSr, " &
                  " '' As ReferenceDocId, " &
        ...
        Else
            mQry = " SELECT Max(I.Code) AS Code, Max(I.Description) AS Description, " &
                     ...
                     " Max(U.DecimalPlaces) As QtyDecimalPlaces, Max(U1.DecimalPlaces) As MeasureDecimalPlaces, " &
                     " Max(I.BillingOn) as BillingType, '' As SaleChallan, '' As SaleChallanNo, 0 As SaleChallanSr, " &
                     " L.ReferenceDocID, L.ReferenceDocIDSr,  " &
