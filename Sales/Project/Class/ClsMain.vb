...
Public Class ClsMain
    ...
    Public Const ModuleName As String = "SALES"
...
#Region " Structure Update Code "
    Public Sub UpdateTableStructure()
        ...
        AgL.AddFieldSqlite("Voucher_Type_Settings", "IsVisible_FreeQty", "bit", "0")
        AgL.AddFieldSqlite("Voucher_Type_Settings", "IsVisible_FreeMeasure", "bit", "0")
        AgL.AddFieldSqlite("Voucher_Type_Settings", "IsVisible_Qty", "bit", "1")
        AgL.AddFieldSqlite("Voucher_Type_Settings", "IsVisible_Unit", "bit", "1")
        AgL.AddFieldSqlite("Voucher_Type_Settings", "IsVisible_Deal", "bit", "1")
        AgL.AddFieldSqlite("Voucher_Type_Settings", "IsVisible_MRP", "bit", "0")
        AgL.AddFieldSqlite("Voucher_Type_Settings", "IsVisible_ExpiryDate", "bit", "0")
        AgL.AddFieldSqlite("SaleInvoice", "Agent", "nVarchar(10)", "Null", True, " references SubGroup(SubCode) ")
        AgL.AddFieldSqlite("SaleInvoice", "SaleToPartyLstNo", "nVarchar(50)", "Null")
        AgL.AddFieldSqlite("SaleInvoiceDetail", "TransactionType", "nVarchar(10)", "Null")
        AgL.AddFieldSqlite("SaleInvoiceDetail", "DeliveryMeasurePerPcs", "Float", "0")
        AgL.AddFieldSqlite("SaleInvoiceDetail", "PcsPerMeasure", "Float", "0")
        AgL.AddFieldSqlite("SaleChallan", "SaleToPartyAdd1", "nVarchar(100)", "Null")
        AgL.AddFieldSqlite("SaleChallan", "SaleToPartyAdd2", "nVarchar(100)", "Null")
        AgL.AddFieldSqlite("SaleChallan", "BillToParty", "nVarchar(10)", "Null", True, " references SubGroup(SubCode) ")
        AgL.AddFieldSqlite("SaleChallan", "Agent", "nVarchar(10)", "Null", True, " references SubGroup(SubCode) ")
        AgL.AddFieldSqlite("SaleChallan", "CreditDays", "int", "0")
        AgL.AddFieldSqlite("SaleChallan", "CreditLimit", "Float", "0")
        AgL.AddFieldSqlite("SaleChallan", "CustomFields", "nVarchar(10)", "Null", True, " references CustomFields(Code) ")
        AgL.AddFieldSqlite("SaleChallan", "Upline", "nVarchar(10)", "Null", True, " references SubGroup(SubCode) ")
        AgL.AddFieldSqlite("Ledger", "CreditDays", "int", "0")
        AgL.AddFieldSqlite("SaleChallanDetail", "MRP", "Float", "0")
        AgL.AddFieldSqlite("SaleChallanDetail", "Landed_Value", "Float", "0")
        AgL.AddFieldSqlite("SaleChallanDetail", "FreeQty", "Float", "0")
        AgL.AddFieldSqlite("SaleChallanDetail", "TotalDeliveryMeasure", "Float", "0")
        AgL.AddFieldSqlite("SaleChallanDetail", "DeliveryMeasureMultiplier", "Float", "0")
        AgL.AddFieldSqlite("SaleChallanDetail", "TotalFreeDeliveryMeasure", "Float", "0")
        AgL.AddFieldSqlite("SaleChallanDetail", "TotalDocDeliveryMeasure", "Float", "0")
        AgL.AddFieldSqlite("SaleChallanDetail", "DeliveryMeasure", "Float", "0")
        AgL.AddFieldSqlite("SaleChallanDetail", "TotalFreeMeasure", "Float", "0")
        AgL.AddFieldSqlite("SaleChallanDetail", "SaleOrderSr", "int", "Null")
        AgL.AddFieldSqlite("SaleChallanDetail", "Item_UID", "nVarchar(20)", "Null")
        AgL.AddFieldSqlite("SaleChallanDetail", "BillingType", "nVarchar(10)", "Null")
        AgL.AddFieldSqlite("SaleChallanDetail", "ExpiryDate", "DateTime", "Null")
        AgL.AddFieldSqlite("SaleChallanDetail", "Supplier", "nVarchar(10)", "Null", True, " references SubGroup(SubCode) ")
        AgL.AddFieldSqlite("SaleChallanDetail", "ReferenceDocId", "nVarchar(21)", "Null", True, " references SaleChallan(DocID) ")
        AgL.AddFieldSqlite("SaleChallanDetail", "ReferenceDocIdSr", "int", "Null")
